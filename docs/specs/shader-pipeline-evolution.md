...
The [vision](../vision.md) currently excludes mesh rendering and asset import.
This brief preserves their proposed introduction, rather than silently declaring
them shipped policy. P3/P4 must explicitly reconcile that scope in the vision,
campaign and SDF documentation as the hybrid decision is adopted.
