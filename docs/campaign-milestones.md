...
Per the repository's verification doctrine, each entry names the exact check, command, or test that produced it. For the binding charter and active work plan, see [campaign.md](campaign.md).
