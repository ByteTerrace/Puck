...
- [SDF Handbook](../sdf-wiki/handbook/README.md) — Complete 9-chapter guide to signed-distance evaluation and shader pipelines.
- [SDF Wiki Reference](../sdf-wiki/reference/README.md) — Compact reference on distance bounds, blending, and lighting formulations.
