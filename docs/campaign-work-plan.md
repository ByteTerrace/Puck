# Campaign Work Plan: Tracks, Slices, and Gated Ladder

This document details the engineering work plan behind Puck's campaign: the five technical tracks, slice definitions, architectural decisions across game systems, future waves, the gated ladder, and open technical questions.

For the binding charter and active milestone status, see [campaign.md](campaign.md). For earlier test runs and verification logs, see [campaign-milestones.md](campaign-milestones.md).
