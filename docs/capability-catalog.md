...
| Steam Controller classic | 🔶 | Wired and receiver variants use the classic vendor protocol. The newer `0x1304` device dialect is detected but not supported. |
