...
- [docs/rendering/sdf/reference/README.md](../reference/README.md) — the standing
  determinism/parity constraints referenced throughout this handbook.
- [docs/rendering/sdf/reference/marching-acceleration.md](../reference/marching-acceleration.md)
  and
