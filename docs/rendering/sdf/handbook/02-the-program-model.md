...
the CPU for physics queries (see [chapter 7](07-queries-and-determinism.md)).
...
- The accumulator rule, the intersection-annihilation bug, and the `Xor`
  exemption: [the SDF world contract](../../../../.claude/skills/sdf-world/SKILL.md)
  ("The accumulator rule"), including the `SdfBlendOp` guidance.
