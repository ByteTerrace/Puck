...
The state system, its ceilings and costs, the authoring language, and the games that prove them, as one page of packages. Forcing artifact: the forcing world, Baba Is You, and Go at 19×19. Its decisions are in [the register](../decisions/state-and-language.md).
