...
- [Puck Model Context Protocol](puck-mcp-plan.md) — MCP hosting, tools, trust, capture, and release gates.
...
- [Game development](game-development.md) — campaign sequencing, detailed game topic plans, future waves, federation work, and verification requirements.

The current world architecture is owned by [architecture/worlds.md](../architecture/worlds.md). The [game design](../game/design.md) owns the binding reference-game charter; its detailed implementation work remains in the game development plan.
