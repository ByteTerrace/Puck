# Humble Gaming Brick cartridge compiler and firmware tooling
...
[cartridge authoring guide](../shared/cartridge-forge.md) documents
...
- [Cartridge Forge authoring](../shared/cartridge-forge.md)
- [HGB embedding](embedding.md)
