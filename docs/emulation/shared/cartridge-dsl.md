# Puck DSL cartridge transpilation

Authors `puck.cartridge.v1` documents in the Puck DSL. The language itself—parser, syntax tree, diagnostics,
formatter, units—is [`Puck.Transpiler`](../../reference/dsl.md); this project is the vocabulary that knows
...
`groupBy`—[`Puck.Transpiler`](../../reference/dsl.md#collection-builtins-and-lambdas)) run at compile time,
...
- [Machine emulation manual](../README.md)
- [Cartridge Forge authoring](cartridge-forge.md)
- [Puck DSL](../../reference/dsl.md)
