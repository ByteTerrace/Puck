...
Read [worlds manual](../../architecture/worlds.md), [the campaign](../design.md), [the contributing guide](../../development/contributing.md), and the applicable repository skills before changing code. Use the live source to resolve any contradiction; historical comments and examples are evidence, not a guarantee of runtime behavior.
