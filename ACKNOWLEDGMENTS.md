...
- **Erin Catto** — [box3d](https://github.com/erincatto/box3d) (MIT), the design reference for the rigid-dynamics re-derivation in `Puck.Dynamics.Spike.Tests`: substep soft constraints, sequential impulses with warm starting, persistent manifolds, and speculative activation.
