...
internal static unsafe partial class Vk
{
    ...
    {
        s_getSurfaceCaps = (delegate* unmanaged<nint, ulong, VkSurfaceCapabilitiesKhr*, int>)InstanceProc(Instance, "vkGetPhysicalDeviceSurfaceCapabilitiesKHR");
        s_getSurfaceFormats = (delegate* unmanaged<nint, ulong, uint*, VkSurfaceFormatKhr*, int>)InstanceProc(Instance, "vkGetPhysicalDeviceSurfaceFormatsKHR");
        s_createSwapchain = (delegate* unmanaged<nint, VkSwapchainCreateInfoKhr*, nint, ulong*, int>)DeviceProc("vkCreateSwapchainKHR");
        s_getSwapchainImages = (delegate* unmanaged<nint, ulong, uint*, ulong*, int>)DeviceProc("vkGetSwapchainImagesKHR");
        s_createImageView = (delegate* unmanaged<nint, VkImageViewCreateInfo*, nint, ulong*, int>)DeviceProc("vkCreateImageView");
        s_createRenderPass = (delegate* unmanaged<nint, VkRenderPassCreateInfo*, nint, ulong*, int>)DeviceProc("vkCreateRenderPass");
        s_createFramebuffer = (delegate* unmanaged<nint, VkFramebufferCreateInfo*, nint, ulong*, int>)DeviceProc("vkCreateFramebuffer");
        s_createCommandPool = (delegate* unmanaged<nint, VkCommandPoolCreateInfo*, nint, ulong*, int>)DeviceProc("vkCreateCommandPool");
        s_allocateCommandBuffers = (delegate* unmanaged<nint, VkCommandBufferAllocateInfo*, nint*, int>)DeviceProc("vkAllocateCommandBuffers");
        s_beginCommandBuffer = (delegate* unmanaged<nint, VkCommandBufferBeginInfo*, int>)DeviceProc("vkBeginCommandBuffer");
        s_cmdBeginRenderPass = (delegate* unmanaged<nint, VkRenderPassBeginInfo*, uint, void>)DeviceProc("vkCmdBeginRenderPass");
        s_cmdEndRenderPass = (delegate* unmanaged<nint, void>)DeviceProc("vkCmdEndRenderPass");
        s_endCommandBuffer = (delegate* unmanaged<nint, int>)DeviceProc("vkEndCommandBuffer");
        s_createSemaphore = (delegate* unmanaged<nint, VkSemaphoreCreateInfo*, nint, ulong*, int>)DeviceProc("vkCreateSemaphore");
        s_acquireNextImage = (delegate* unmanaged<nint, ulong, ulong, ulong, ulong, uint*, int>)DeviceProc("vkAcquireNextImageKHR");
        s_queueSubmit = (delegate* unmanaged<nint, uint, VkSubmitInfo*, ulong, int>)DeviceProc("vkQueueSubmit");
        s_queuePresent = (delegate* unmanaged<nint, VkPresentInfoKhr*, int>)DeviceProc("vkQueuePresentKHR");
        s_queueWaitIdle = (delegate* unmanaged<nint, int>)DeviceProc("vkQueueWaitIdle");
        s_deviceWaitIdle = (delegate* unmanaged<nint, int>)DeviceProc("vkDeviceWaitIdle");

        s_destroySemaphore = (delegate* unmanaged<nint, ulong, nint, void>)DeviceProc("vkDestroySemaphore");
        s_destroyCommandPool = (delegate* unmanaged<nint, ulong, nint, void>)DeviceProc("vkDestroyCommandPool");
        s_destroyFramebuffer = (delegate* unmanaged<nint, ulong, nint, void>)DeviceProc("vkDestroyFramebuffer");
        s_destroyImageView = (delegate* unmanaged<nint, ulong, nint, void>)DeviceProc("vkDestroyImageView");
        s_destroyRenderPass = (delegate* unmanaged<nint, ulong, nint, void>)DeviceProc("vkDestroyRenderPass");
        s_destroySwapchain = (delegate* unmanaged<nint, ulong, nint, void>)DeviceProc("vkDestroySwapchainKHR");
        s_destroyDevice = (delegate* unmanaged<nint, nint, void>)InstanceProc(Instance, "vkDestroyDevice");
        s_destroySurface = (delegate* unmanaged<nint, ulong, nint, void>)InstanceProc(Instance, "vkDestroySurfaceKHR");
        s_destroyInstance = (delegate* unmanaged<nint, nint, void>)InstanceProc(Instance, "vkDestroyInstance");
    }
    ...
    {
        if (Device != 0 && s_deviceWaitIdle != null)
        ...
        Diag.Log("vulkan teardown complete");
    }
    ...
    public static bool InitializeRendering(uint width, uint height)
    {
        ...
        if (formatCount == 0) { Diag.Log("no surface formats"); return false; }
        ...
        if (r != 0) { Diag.LogNum("vkCreateSwapchainKHR failed", r); return false; }
        ...
        Diag.LogNum("swapchain images:", s_imageCount);
        ...
        if (r != 0) { Diag.LogNum("vkCreateRenderPass failed", r); return false; }
        ...
        for (uint i = 0; i < s_imageCount; i++)
        {
            ...
            if (r != 0) { Diag.LogNum("vkCreateImageView failed", r); return false; }
            s_imageViews[i] = view;
            ...
            if (r != 0) { Diag.LogNum("vkCreateFramebuffer failed", r); return false; }
        ...
        if (r != 0) { Diag.LogNum("vkCreateCommandPool failed", r); return false; }
        s_commandPool = pool;
        ...
        if (r != 0) { Diag.LogNum("vkAllocateCommandBuffers failed", r); return false; }
        ...
        Diag.Log("swapchain + render pass ready");
        return true;
    }
