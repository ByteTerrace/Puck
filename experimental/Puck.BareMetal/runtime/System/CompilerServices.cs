...
namespace System.Runtime.CompilerServices
{
    ...
    public static unsafe class RuntimeHelpers
    {
        ...
        public static unsafe int GetHashCode(object o) => (int)(nint)Unsafe.As<object, IntPtr>(ref o);
    ...
    public static unsafe class Unsafe
    {
        ...
        [Intrinsic] public static ref T AsRef<T>(void* source) => ref AsRef<T>(source);
        [Intrinsic] public static ref T AsRef<T>(scoped ref readonly T source) => ref AsRef(in source);
        [Intrinsic] public static ref TTo As<TFrom, TTo>(ref TFrom source) => ref As<TFrom, TTo>(ref source);
        [Intrinsic] public static T As<T>(object value) where T : class => As<T>(value);
        [Intrinsic] public static ref T Add<T>(ref T source, int elementOffset) => ref Add(ref source, elementOffset);
        [Intrinsic] public static ref T Add<T>(ref T source, nint elementOffset) => ref Add(ref source, elementOffset);
        [Intrinsic] public static ref T AddByteOffset<T>(ref T source, nint byteOffset) => ref AddByteOffset(ref source, byteOffset);
        [Intrinsic] public static nint ByteOffset<T>(ref readonly T origin, ref readonly T target) => (nint)((byte*)AsPointer(ref AsRef(in target)) - (byte*)AsPointer(ref AsRef(in origin)));
        [Intrinsic] public static bool AreSame<T>(ref readonly T left, ref readonly T right) => AsPointer(ref AsRef(in left)) == AsPointer(ref AsRef(in right));
        [Intrinsic] public static bool IsNullRef<T>(ref readonly T source) => AsPointer(ref AsRef(in source)) == null;
        [Intrinsic] public static ref T NullRef<T>() => ref AsRef<T>(null);
        [Intrinsic] public static T ReadUnaligned<T>(void* source) => ReadUnaligned<T>(source);
        [Intrinsic] public static void WriteUnaligned<T>(void* destination, T value) => WriteUnaligned(destination, value);
        [Intrinsic] public static T ReadUnaligned<T>(ref readonly byte source) => ReadUnaligned<T>(in source);
        [Intrinsic] public static void WriteUnaligned<T>(ref byte destination, T value) => WriteUnaligned(ref destination, value);
