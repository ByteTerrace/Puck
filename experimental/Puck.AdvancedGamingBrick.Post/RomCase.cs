...
/// Game Boy Advance is a single hardware model, so — unlike the Game Boy / Game Boy Color corpus — there is no per-case
/// console-model dimension.</summary>
/// <param name="Group">The group (e.g. "jsmolka-cpu") the case belongs to.</param>
