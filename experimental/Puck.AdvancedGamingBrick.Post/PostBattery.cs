...
/// <summary>Runs an ordered list of <see cref="IPostStage"/> once each, isolating failures so one stage's infrastructure
/// failure (an exception, recorded as <see cref="PostVerdict.Infra"/>) never aborts the rest, and gathers the results
/// into a <see cref="PostReport"/>.</summary>
