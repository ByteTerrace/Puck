...
internal static class OracleProbes {
    ...
    // -------------------------------------------------------------------------------------------------------------
    // Component-level probe: the hardware-measured Direct Sound FIFO (7-word ring + 32-bit playing buffer, mGBA
    // #1847). We drive AgbApu directly and assert the model's documented properties. Expected values are DERIVED FROM
    // THE MODEL SPEC, so this is a true self-checking gate.
    // -------------------------------------------------------------------------------------------------------------
