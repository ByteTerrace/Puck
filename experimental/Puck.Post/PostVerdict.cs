...
internal enum PostVerdict {
    ...
    Pass,
    /// <summary>The stage was skipped (e.g. an unsupported adapter); neutral to the aggregate verdict.</summary>
    Skip,
    /// <summary>A check failed — a correctness divergence. Folds to process exit code 1.</summary>
    Fail,
    /// <summary>The stage could not run to completion (an exception or a missing capability). Folds to exit code 2.</summary>
    Infra,
}
