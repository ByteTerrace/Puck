...
internal sealed class WorldAnalyticNormalStage : IPostStage {
    ...
    internal static SdfProgram BuildAnalyticNormalScene() {
        ...
        var copper = builder.AddMaterial(material: new SdfMaterial(Albedo: new Vector3(x: 0.85f, y: 0.45f, z: 0.15f), Emissive: 0.25f));
        var jade = builder.AddMaterial(material: new SdfMaterial(Albedo: new Vector3(x: 0.2f, y: 0.72f, z: 0.45f)));
        var azure = builder.AddMaterial(material: new SdfMaterial(Albedo: new Vector3(x: 0.2f, y: 0.45f, z: 0.85f)));
        ...
        return builder
            ...
            .ResetPoint()
            .Translate(offset: new Vector3(x: -2.4f, y: 1.0f, z: 0f))
            .TwistY(rate: 1.4f)
            .Box(halfExtents: new Vector3(x: 0.5f, y: 1.0f, z: 0.5f), round: 0.05f, material: brick)
            ...
            .ResetPoint()
            .Translate(offset: new Vector3(x: 2.4f, y: 0.28f, z: 0f))
            .RepeatLimited(spacing: new Vector3(x: 0.72f, y: 2.0f, z: 0.72f), limit: new Vector3(x: 2f, y: 0f, z: 2f))
            ...
            .Translate(offset: new Vector3(x: 0f, y: 0.95f, z: 0f))
            ...
            .ResetPoint()
            .Translate(offset: new Vector3(x: -0.2f, y: 0.45f, z: 2.1f))
            .Sphere(radius: 0.42f, material: azure)
            .ResetPoint()
            .Translate(offset: new Vector3(x: 0.7f, y: 0.45f, z: 2.1f))
