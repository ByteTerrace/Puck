...
//
//   dotnet run -c Release src/Puck.World/scripts/proof.cs -- <subcommand> [options]
//
// Subcommands:
...
static class GrantsProof {
    ...
    static bool RunProfileSubjectRound(Ctx ctx) {
        ...
        passed &= ExpectGrant(ctx: ctx, name: "edit-denied-without-grant",
            ...
            needle: "[profile.section: console cannot edit profile:amber (no grant names it)]");
        ...
        passed &= ExpectGrant(ctx: ctx, name: "other-profile-still-denied",
            ...
            needle: "[profile.section: console cannot edit profile:cobalt (no grant names it)]");
    ...
    static bool RunSectionEditSession(string exe, string repoRoot, int width, int height, int exitAfterSeconds) {
        ...
        try {
            ...
            passed &= ExpectSection(ctx: ctx, name: "bindings-section-applies",
                line: "profile.section amber bindings {\"version\":\"puck.bindings.v1\",\"modifiers\":[],\"chords\":[{\"group\":\"play\",\"chord\":[],\"page\":{\"id\":\"base\",\"entries\":[{\"source\":\"keyboard.q\",\"command\":\"player.forward\"}]}}]}",
