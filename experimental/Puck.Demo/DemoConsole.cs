...
internal sealed class DemoConsole {
    ...
    // or the console.move verb, cleared by console.reset. Null = the default token-derived rect.
    ...
    /// <summary>Sets a client-space, top-left override for the on-screen panel's position — the write side a
    /// title-band drag and the <c>console.move</c> verb use.
