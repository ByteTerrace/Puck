...
/// the binding documents' chord vocabulary (bare, [LT], [RT], [LT,RT], [RT,LT] — pressing LT
...
///
/// <para><b>The chord/page map</b> (12 physical slots per page, in fixed slot order —
...
internal sealed class WorldSculptController {
    /// <summary>The order-sensitive chord pages, in the profile chord vocabulary
    /// (LT = the left modifier, RT = the right).</summary>
    public enum Page {
