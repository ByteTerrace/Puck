...
/// the same way a game's own tables declare its data. The streams share one grammar the driver's
...
/// <see cref="EffectWin"/> exactly like any game triggers its own set.
/// </summary>
internal static class SoundTables {
    ...
    /// <summary>A tiny single pulse tick — cursor/menu movement (a falling-block game would use it for a rotate).</summary>
    ...
    /// <summary>A rising hardware-sweep zip — a line clear, a cascade, any "that resolved" moment.</summary>
