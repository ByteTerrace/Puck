...
public sealed class FieldWalkerBody {
    ...
    private FixedPosition m_previousPosition;
    ...
    public FieldWalkerBody(FixedPosition position, FixedVector3 up) {
        Position = position;
        Up = up.Normalize();
    ...
    public Vector3 RenderRelativePositionAt(FixedPosition renderOrigin, float alpha) =>
        Vector3.Lerp(
            amount: alpha,
