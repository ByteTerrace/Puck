...
public sealed partial class OverworldFrameSource {
    ...
    // false disables the F2 soft-shadow light-side early exit (SdfFrame.DisableShadowEscapeExit — a march-path change).
    ...
    /// <summary>The live F2 shadow-far-exit isolator (<see cref="SdfFrame.DisableShadowEscapeExit"/>, inverted).
