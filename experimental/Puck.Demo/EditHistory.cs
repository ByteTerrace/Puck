...
/// tail (the standard model); exceeding capacity silently ages out the oldest snapshot (the saturating-ring
/// shape, host-side). Deliberate save is a keep-point, not a boundary — the
/// history survives it.
/// </summary>
