...
/// <summary>
/// The audio-processing unit: the four legacy PSG channels (two square, wave, noise) plus the Game Boy
/// Advance's two Direct Sound FIFO channels, mixed per SOUNDCNT into a stereo stream. Advanced on the master
...
/// </summary>
public interface IGbaApu : IGbaClockedComponent {
