...
/// overflow. Stepped one master cycle at a time (the cycle-stepped hardware reference) so cascade and reload-latch timing are
...
public interface IAgbTimerController {
    ...
    /// reload-latch / step-latch sequence of the cycle-stepped hardware reference).</summary>
