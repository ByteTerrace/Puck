...
/// <summary>
/// The Hudson HuC3 mapper: full-byte ROM banking (a written zero reading as one), full-byte RAM banking, an infrared
...
/// </para>
/// </summary>
public sealed class HuC3Cartridge : CartridgeBase, IClockedComponent {
