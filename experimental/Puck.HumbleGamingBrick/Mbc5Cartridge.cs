...
/// which is why CGB titles that stream from bank zero rely on it.
/// </summary>
public sealed class Mbc5Cartridge : CartridgeBase {
    ...
    /// <summary>Creates an MBC5 cartridge with its registers at reset (ROM bank 1, RAM disabled).</summary>
    ...
    public override void WriteControl(ushort address, byte value) {
        switch (address >> 12) {
            ...
            case 3: // 0x3000-0x3FFF: ninth ROM-bank bit
                ...
                break;
            case 4: // 0x4000-0x4FFF: RAM bank
            case 5: // 0x5000-0x5FFF: RAM bank
