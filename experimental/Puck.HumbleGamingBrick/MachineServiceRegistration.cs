...
/// <summary>
/// The composition root for a Humble GamingBrick machine. It registers the timing core and the <see cref="Machine"/>
...
public static class MachineServiceRegistration {
    /// <summary>Registers the shared Humble GamingBrick services. The caller adds a per-machine
