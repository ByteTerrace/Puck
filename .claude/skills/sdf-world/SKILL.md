...
`NoHeightSentinel` and would erase the cells it authored) and a grid spanning
more cells than a 32-bit cell index addresses. `SdfFieldEvaluator` (GRAVITY ARC Wave 1) wraps a LIVE
