...
**Queries (`Puck.SignedDistance.Queries`).** `IWorldQuery`
...
measured tolerances. `IFieldEvaluator`
...
either. The one on-demand check is `puck parity` (docs/verification/parity/):
