...
/// <summary>
/// The Advanced GamingBrick composition root. Every subsystem (CPU, PPU, APU, DMA, timers, interrupt controller,
...
/// </para>
/// </summary>
public static class AdvancedGamingBrickServiceRegistration {
    /// <summary>Registers the shared Advanced GamingBrick services. Subsystems are added here as they are built;
    ...
    public static IServiceCollection AddAdvancedGamingBrick(this IServiceCollection services) {
        ...
        // AgbCartridge and a BIOS (AddReplacementBios) before resolving the machine.
        services.TryAddScoped<AgbScheduler>();
        services.TryAddScoped<IArmCpu, Arm7Tdmi>();
        services.TryAddScoped<IAgbInterruptController, AgbInterruptController>();
        services.TryAddScoped<IAgbTimerController, AgbTimerController>();
        services.TryAddScoped<IAgbDmaController, AgbDmaController>();
        services.TryAddScoped<IAgbSerialController, AgbSerialController>();
        services.TryAddScoped<IAgbPpu, AgbPpu>();
        services.TryAddScoped<IAgbApu, AgbApu>();
        services.TryAddScoped<IAgbBus, AgbBus>();
        services.TryAddScoped<AdvancedGamingBrickMachine>();
