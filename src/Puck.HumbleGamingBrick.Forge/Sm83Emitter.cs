...
public sealed class Sm83Emitter {
    ...
    public ushort LabelAddress(int label, ushort baseAddress) =>
        (ushort)(baseAddress + m_labels.Resolve(kind: "A vector", label: label));
    ...
    public void JumpAbsolute(int label) => EmitAbsolute(label: label, opcode: 0xC3);
    /// <summary>jp cc, label — absolute jump taken when <paramref name="condition"/> holds.</summary>
    public void JumpAbsolute(Condition condition, int label) => EmitAbsolute(label: label, opcode: ((byte)(0xC2 + (((byte)condition) * 8))));
    ...
    public void Call(int label) => EmitAbsolute(label: label, opcode: 0xCD);
    /// <summary>call cc, label — conditional absolute call.</summary>
    public void Call(Condition condition, int label) => EmitAbsolute(label: label, opcode: ((byte)(0xC4 + (((byte)condition) * 8))));
