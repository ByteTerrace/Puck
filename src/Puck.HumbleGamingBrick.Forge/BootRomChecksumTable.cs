...
internal static class BootRomChecksumTable {
    ...
    private static readonly ushort CommonValue = MostCommon(contributions: BootDivPrediction.ChecksumContributions);
    private static readonly byte[] RowsValue = BuildRows(contributions: BootDivPrediction.ChecksumContributions);
