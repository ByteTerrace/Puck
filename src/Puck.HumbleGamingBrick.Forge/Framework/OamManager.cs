...
public sealed class OamManager {
    ...
    public void EmitSetSprite(int slot) {
        ...
        m_emitter.StoreAToAddress(address: SpriteAddress(byteIndex: 0, slot: slot));
        m_emitter.Load(destination: Reg8.A, source: Reg8.C);
        m_emitter.StoreAToAddress(address: SpriteAddress(byteIndex: 1, slot: slot));
        m_emitter.Load(destination: Reg8.A, source: Reg8.D);
        m_emitter.StoreAToAddress(address: SpriteAddress(byteIndex: 2, slot: slot));
        m_emitter.Load(destination: Reg8.A, source: Reg8.E);
        m_emitter.StoreAToAddress(address: SpriteAddress(byteIndex: 3, slot: slot));
    }
