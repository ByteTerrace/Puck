...
public sealed class SaveModule {
    ...
    private void EmitLoadSubroutine() {
        ...
        FrameworkKernel.EmitBlockCopy(byteCount: ((ushort)payloadCount), destinationAddress: FrameworkMemoryMap.SaveMirror, emitter: m_emitter, sourceAddress: PayloadBase);
    ...
    private void EmitStoreSubroutine() {
        ...
        FrameworkKernel.EmitBlockCopy(byteCount: ((ushort)payloadCount), destinationAddress: PayloadBase, emitter: m_emitter, sourceAddress: FrameworkMemoryMap.SaveMirror);
