...
/// <c>Puck.HumbleGamingBrick.Forge.Tune.TuneGame</c>'s shape (the smallest existing framework game): one manifest, one state, a
/// <c>Build</c>/<c>Verify</c> facade pair.
/// </summary>
public sealed class ArcadeQuestGame {
