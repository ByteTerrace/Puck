...
/// partially written or torn frames. The generic collapse of the copy-paste <c>Holder</c> idiom formerly duplicated
/// between the binding bar and the developer console's own state stores.
/// </summary>
/// <typeparam name="T">The immutable frame type published each write (a record/record struct snapshot).</typeparam>
internal sealed class PublishBuffer<T> {
