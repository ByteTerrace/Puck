...
internal static class FlagshipCrtRobot {
    ...
    public static CreationDocument BuildCrtRobot() {
        ...
        // badge rides on it.
        _ = PlaceNamed(scene: scene, name: "torso", type: AvatarPrimitive.Box, position: new Vector3(0f, 1.2f, 0f), scale: new Vector3(1.08f, 1.1f, 0.68f), material: MatBodySlate);
        _ = PlaceNamed(scene: scene, name: "chestPlate", type: AvatarPrimitive.Box, position: new Vector3(0f, 1.4f, 0.32f), scale: new Vector3(0.66f, 0.5f, 0.1f), material: MatShellCream, onion: 0f);
        ...
        _ = PlaceNamed(scene: scene, name: "hips", type: AvatarPrimitive.Box, position: new Vector3(0f, 0.72f, 0f), scale: new Vector3(0.94f, 0.44f, 0.66f), material: MatBodySlate);
        ...
        _ = PlaceNamed(scene: scene, name: "emblemRing", type: AvatarPrimitive.Torus, position: new Vector3(0f, 1.4f, 0.38f), rotation: Quaternion.CreateFromAxisAngle(axis: Vector3.UnitX, angle: (0.5f * MathF.PI)), scale: new Vector3(0.28f, 0.28f, 0.28f), material: MatBezelGlow);
        _ = PlaceNamed(scene: scene, name: "emblemCore", type: AvatarPrimitive.Sphere, position: new Vector3(0f, 1.4f, 0.4f), scale: new Vector3(0.2f, 0.2f, 0.16f), material: MatAccentOrange);
        ...
        _ = PlaceNamed(scene: scene, name: "head", type: AvatarPrimitive.Box, position: new Vector3(0f, 2.14f, -0.06f), scale: new Vector3(1.32f, 1.14f, 0.9f), material: MatShellCream, onion: 0f);

        // A thin cream "neck" collar so the head doesn't float — a short wide cylinder bridging torso→head.
        _ = PlaceNamed(scene: scene, name: "neck", type: AvatarPrimitive.Cylinder, position: new Vector3(0f, 1.66f, 0f), scale: new Vector3(0.6f, 0.44f, 0.6f), material: MatShellCream);

        // Two little orange "ear" tuning-knobs on the head sides — chunky charm, and they read at small size.
        _ = PlaceNamed(scene: scene, name: "earLeft", type: AvatarPrimitive.Cylinder, position: new Vector3(-0.9f, 2.16f, -0.04f), rotation: Quaternion.CreateFromAxisAngle(axis: Vector3.UnitZ, angle: (0.5f * MathF.PI)), scale: new Vector3(0.34f, 0.42f, 0.34f), material: MatAccentOrange);
        _ = PlaceNamed(scene: scene, name: "earRight", type: AvatarPrimitive.Cylinder, position: new Vector3(0.9f, 2.16f, -0.04f), rotation: Quaternion.CreateFromAxisAngle(axis: Vector3.UnitZ, angle: (0.5f * MathF.PI)), scale: new Vector3(0.34f, 0.42f, 0.34f), material: MatAccentOrange);
        ...
        _ = PlaceNamed(scene: scene, name: "mouth", type: AvatarPrimitive.Capsule, position: new Vector3(0f, 1.94f, 0.5f), rotation: Quaternion.CreateFromAxisAngle(axis: Vector3.UnitZ, angle: (0.5f * MathF.PI)), scale: new Vector3(0.2f, 0.34f, 0.2f), material: MatBezelGlow);
        ...
        _ = PlaceNamed(scene: scene, name: "antennaStalk", type: AvatarPrimitive.RoundCone, position: new Vector3(0.22f, 2.74f, -0.08f), rotation: Quaternion.CreateFromAxisAngle(axis: Vector3.UnitZ, angle: (-0.16f)), scale: new Vector3(0.36f, 0.86f, 0.36f), material: MatShellCream);
        _ = PlaceNamed(scene: scene, name: "antennaTip", type: AvatarPrimitive.Sphere, position: new Vector3(0.34f, 3.08f, -0.08f), scale: new Vector3(0.3f, 0.3f, 0.3f), material: MatBezelGlow);
        ...
        DefineArm(scene: scene, name: "armLeft", root: new Vector3(-1.02f, 1.5f, 0f), mid: new Vector3(-1.28f, 1.12f, 0.02f), tip: new Vector3(-1.34f, 0.74f, 0.05f));
        DefineArm(scene: scene, name: "armRight", root: new Vector3(1.02f, 1.5f, 0f), mid: new Vector3(1.28f, 1.12f, 0.02f), tip: new Vector3(1.34f, 0.74f, 0.05f));
        DefineLeg(scene: scene, name: "legLeft", root: new Vector3(-0.36f, 0.66f, 0.02f), mid: new Vector3(-0.37f, 0.42f, 0.04f), tip: new Vector3(-0.38f, 0.12f, 0.1f));
        DefineLeg(scene: scene, name: "legRight", root: new Vector3(0.36f, 0.66f, 0.02f), mid: new Vector3(0.37f, 0.42f, 0.04f), tip: new Vector3(0.38f, 0.12f, 0.1f));
        ...
        SetChainGoal(scene: scene, chainName: "armRight", goal: new Vector3(1.5f, 2.28f, 0.35f));
        SetChainGoal(scene: scene, chainName: "armLeft", goal: new Vector3(-1.2f, 1.02f, 0.5f));
        _ = scene.RecordFrame();
        ResetTimelineCursor(scene: scene);
    ...
    private static void PaintPalette(CreatorScene scene) {
        ...
        scene.SetPaletteEntry(index: MatShellCream, material: new SdfMaterial(Albedo: new Vector3(0.96f, 0.9f, 0.76f), Emissive: 0.06f, Specular: 0.16f, Shininess: 26f));
        scene.SetPaletteEntry(index: MatBodySlate, material: new SdfMaterial(Albedo: new Vector3(0.42f, 0.4f, 0.45f), Emissive: 0.04f, Specular: 0.14f, Shininess: 22f));
        scene.SetPaletteEntry(index: MatAccentOrange, material: new SdfMaterial(Albedo: new Vector3(0.98f, 0.48f, 0.14f), Emissive: 0.22f, Specular: 0.24f, Shininess: 32f));
        scene.SetPaletteEntry(index: MatScreenDark, material: new SdfMaterial(Albedo: new Vector3(0.06f, 0.09f, 0.12f), Emissive: 0f, Specular: 0.4f, Shininess: 72f));
        scene.SetPaletteEntry(index: MatBezelGlow, material: new SdfMaterial(Albedo: new Vector3(1.0f, 0.56f, 0.2f), Emissive: 1.15f, Specular: 0.15f, Shininess: 28f));
        scene.SetPaletteEntry(index: MatEyeWhite, material: new SdfMaterial(Albedo: new Vector3(0.99f, 0.98f, 0.94f), Emissive: 0.62f, Specular: 0.22f, Shininess: 44f));
        scene.SetPaletteEntry(index: MatEyeDark, material: new SdfMaterial(Albedo: new Vector3(0.05f, 0.06f, 0.09f), Emissive: 0f, Specular: 0.45f, Shininess: 64f));
        scene.SetPaletteEntry(index: MatFootSlate, material: new SdfMaterial(Albedo: new Vector3(0.28f, 0.27f, 0.3f), Emissive: 0f, Specular: 0.1f, Shininess: 18f));
    }
    ...
    private static void PlaceEye(CreatorScene scene, string side, float x) {
        ...
        _ = PlaceNamed(scene: scene, name: $"eye{side}Sclera", type: AvatarPrimitive.Sphere, position: new Vector3(x, 2.25f, 0.48f), scale: new Vector3(0.38f, 0.42f, 0.3f), material: MatEyeWhite);
        _ = PlaceNamed(scene: scene, name: $"eye{side}Pupil", type: AvatarPrimitive.Sphere, position: new Vector3(x, 2.21f, 0.58f), scale: new Vector3(0.24f, 0.28f, 0.22f), material: MatEyeDark);
        _ = PlaceNamed(scene: scene, name: $"eye{side}Shine", type: AvatarPrimitive.Sphere, position: new Vector3((x - 0.06f), 2.29f, 0.64f), scale: new Vector3(0.1f, 0.1f, 0.09f), material: MatEyeWhite);
    }
    ...
    private static int PlaceNamed(CreatorScene scene, string name, AvatarPrimitive type, Vector3 position, Vector3 scale, int material, Quaternion? rotation = null, float onion = 0f) {
        ...
        _ = scene.Select(idOrName: placedId.ToString(CultureInfo.InvariantCulture));
    ...
    private static void ApplyGhostRotation(CreatorScene scene, Quaternion rotation) {
        ...
        var angle = (2f * MathF.Acos(Math.Clamp(value: rotation.W, max: 1f, min: -1f)));
        var sin = MathF.Sqrt(MathF.Max(0f, (1f - (rotation.W * rotation.W))));
    ...
    private static void DefineArm(CreatorScene scene, string name, Vector3 root, Vector3 mid, Vector3 tip) {
        var rootId = PlaceNamed(scene: scene, name: $"{name}Root", type: AvatarPrimitive.Capsule, position: root, scale: new Vector3(0.5f, 0.42f, 0.5f), material: MatShellCream);
        var midId = PlaceNamed(scene: scene, name: $"{name}Mid", type: AvatarPrimitive.Capsule, position: mid, scale: new Vector3(0.42f, 0.4f, 0.42f), material: MatBodySlate);
        var tipId = PlaceNamed(scene: scene, name: $"{name}Tip", type: AvatarPrimitive.Sphere, position: tip, scale: new Vector3(0.44f, 0.44f, 0.44f), material: MatAccentOrange);

        _ = scene.DefineChain(name: name, shapeIdsOrNames: [Str(rootId), Str(midId), Str(tipId)], kind: CreatorChainState.KindLimb);
    }
    ...
    private static void DefineLeg(CreatorScene scene, string name, Vector3 root, Vector3 mid, Vector3 tip) {
        var rootId = PlaceNamed(scene: scene, name: $"{name}Root", type: AvatarPrimitive.Capsule, position: root, scale: new Vector3(0.5f, 0.42f, 0.5f), material: MatBodySlate);
        var midId = PlaceNamed(scene: scene, name: $"{name}Mid", type: AvatarPrimitive.Capsule, position: mid, scale: new Vector3(0.46f, 0.4f, 0.46f), material: MatBodySlate);
        var tipId = PlaceNamed(scene: scene, name: $"{name}Tip", type: AvatarPrimitive.Box, position: tip, scale: new Vector3(0.52f, 0.34f, 0.72f), material: MatFootSlate);
