...
/// the same way <see cref="BrickfallTables"/> declares its game data. The streams share one grammar the driver's
...
/// <see cref="EffectWin"/> exactly like Brickfall triggers its own set.
/// </summary>
internal static class SoundTables {
    ...
    /// <summary>A tiny single pulse tick — cursor/menu movement (Brickfall: a rotate).</summary>
    ...
    /// <summary>A rising hardware-sweep zip — Brickfall's line clear.</summary>
