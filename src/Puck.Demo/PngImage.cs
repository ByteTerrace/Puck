...
/// <summary>
/// A minimal, dependency-free PNG encoder for capturing rendered buffers to disk: it writes 8-bit RGBA pixels
/// (color type 6) with no row filtering, zlib-compressing the scanlines. Just enough to dump a GPU readback to
/// a viewable file — not a general image library.
/// </summary>
