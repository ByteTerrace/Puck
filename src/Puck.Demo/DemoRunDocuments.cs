...
internal static class DemoRunDocuments {
    ...
    private static string? SelfContainedGateName(DemoFlags flags) {
        ...
        if (flags.ValidateGenlock) { return "genlock"; }
