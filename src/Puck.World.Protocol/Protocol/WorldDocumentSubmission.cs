...
/// the same asymmetry <see cref="StateCell"/>'s own <c>Value</c>/<c>Text</c> pair carries: a string cannot
...
/// <see cref="StateCapacity.MaxTextValueLength"/> refusal every other text-cell write door enforces.</param>
