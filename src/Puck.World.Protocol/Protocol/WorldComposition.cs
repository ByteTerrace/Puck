...
/// for the session, never the document. <c>view.override layout</c>/<c>view.override camera</c> (<c>WorldViewCommandModule</c>) submit
/// through this same path.
/// </summary>
public abstract record WorldComposition {
    ...
    public sealed record SetActiveLayout(string? Name) : WorldComposition;
    ...
    public sealed record SelectCamera(string? Name) : WorldComposition;
}
