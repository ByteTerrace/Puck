...
public sealed record SkyFrameSettings {
    ...
    public Vector3 Zenith { get; init; } = new(
        x: 0.106f,
        y: 0.137f,
        z: 0.314f
    );
    /// <summary>Gets the colour at the horizon.</summary>
    public Vector3 Horizon { get; init; } = new(
        x: 0.878f,
        y: 0.561f,
        z: 0.420f
    );
    /// <summary>Gets the colour below the horizon.</summary>
    public Vector3 Ground { get; init; } = new(
        x: 0.043f,
        y: 0.051f,
        z: 0.078f
    );
    ...
    public Vector3 SunDirection { get; init; } = Vector3.Normalize(value: new Vector3(
        x: 0.6f,
        y: 0.2f,
        z: -0.75f
    ));
    /// <summary>Gets the sun colour.</summary>
    public Vector3 SunColor { get; init; } = new(
        x: 1f,
        y: 0.851f,
        z: 0.651f
    );
    ...
    public Vector3 CloudColor { get; init; } = new(
        x: 0.788f,
        y: 0.749f,
        z: 0.769f
    );
