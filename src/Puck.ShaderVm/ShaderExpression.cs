...
public sealed class ShaderExpression {
    ...
    /// <returns>The node.</returns>
    public static ShaderExpression Constant(float x, float y, float z = 0f, float w = 0f) => Constant4(value: new Vector4(
        w: w,
        x: x,
        y: y,
        z: z
    ...
    /// <returns>The node.</returns>
    public static ShaderExpression ConstantAt(ShaderExpression index) => Unary(
        op: ShaderOp.LoadConstantDynamic,
        value: index
    );
    ...
    /// <returns>The node.</returns>
    public ShaderExpression Lane(int lane) => Swizzle(
        w: lane,
        x: lane,
        y: lane,
        z: lane
    ...
    public static ShaderExpression operator +(ShaderExpression left, ShaderExpression right) => Binary(
        left: left,
        op: ShaderOp.Add,
        right: right
    );
    ...
    public static ShaderExpression operator -(ShaderExpression left, ShaderExpression right) => Binary(
        left: left,
        op: ShaderOp.Subtract,
        right: right
    );
    /// <summary>Multiplies two values.</summary>
    public static ShaderExpression operator *(ShaderExpression left, ShaderExpression right) => Binary(
        left: left,
        op: ShaderOp.Multiply,
        right: right
    );
    ...
    public static ShaderExpression operator -(ShaderExpression value) => Unary(
        op: ShaderOp.Negate,
        value: value
    );
