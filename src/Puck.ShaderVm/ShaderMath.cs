...
public static class ShaderMath {
    ...
    public static ShaderExpression Abs(ShaderExpression value) => ShaderExpression.Unary(
        op: ShaderOp.Absolute,
        value: value
    );
    ...
    /// <returns>The node.</returns>
    public static ShaderExpression Atan2(ShaderExpression ordinate, ShaderExpression abscissa) => ShaderExpression.Binary(
        left: ordinate,
        op: ShaderOp.ArcTangent2,
        right: abscissa
    );
    ...
    /// <returns>The node.</returns>
    public static ShaderExpression Clamp(ShaderExpression value, ShaderExpression min, ShaderExpression max) => ShaderExpression.Ternary(
        a: value,
        b: min,
        c: max,
        op: ShaderOp.Clamp
    ...
    /// <returns>The node.</returns>
    public static ShaderExpression Cos(ShaderExpression value) => ShaderExpression.Unary(
        op: ShaderOp.Cosine,
        value: value
    );
    ...
    /// <returns>The node.</returns>
    public static ShaderExpression Dot2(ShaderExpression left, ShaderExpression right) => ShaderExpression.Binary(
        left: left,
        op: ShaderOp.Dot2,
        right: right
    );
    ...
    /// <param name="right">The second value.</param>
    /// <returns>The node.</returns>
    public static ShaderExpression Dot3(ShaderExpression left, ShaderExpression right) => ShaderExpression.Binary(
        left: left,
        op: ShaderOp.Dot3,
        right: right
    );
    ...
    /// <param name="value">The value.</param>
    /// <returns>The node.</returns>
    public static ShaderExpression Exp(ShaderExpression value) => ShaderExpression.Unary(
        op: ShaderOp.Exponential,
        value: value
    );
    ...
    /// <returns>The node.</returns>
    public static ShaderExpression Fbm2(ShaderExpression position, int octaves) => ShaderExpression.Unary(
        op: ShaderOp.Fbm2,
        operand: checked((uint)octaves),
        value: position
    );
    /// <summary>Takes the component-wise floor.</summary>
    /// <param name="value">The value.</param>
    /// <returns>The node.</returns>
    public static ShaderExpression Floor(ShaderExpression value) => ShaderExpression.Unary(
        op: ShaderOp.Floor,
        value: value
    );
    ...
    /// <param name="value">The value.</param>
    /// <returns>The node.</returns>
    public static ShaderExpression Frac(ShaderExpression value) => ShaderExpression.Unary(
        op: ShaderOp.Fraction,
        value: value
    );
    /// <summary>Hashes three lanes read as unsigned bit patterns, returning the raw result bits.</summary>
    /// <param name="value">The value.</param>
    /// <returns>The node.</returns>
    public static ShaderExpression Hash3(ShaderExpression value) => ShaderExpression.Unary(
        op: ShaderOp.Hash3,
        value: value
    );
    ...
    /// <param name="value">The value.</param>
    /// <returns>The node.</returns>
    public static ShaderExpression IntegerBits(ShaderExpression value) => ShaderExpression.Unary(
        op: ShaderOp.IntegerBits,
        value: value
    );
    ...
    /// <returns>The node.</returns>
    public static ShaderExpression Lerp(ShaderExpression from, ShaderExpression to, ShaderExpression amount) => ShaderExpression.Ternary(
        a: from,
        b: to,
        c: amount,
        op: ShaderOp.Lerp
    ...
    /// <param name="right">The second value.</param>
    /// <returns>The node.</returns>
    public static ShaderExpression Max(ShaderExpression left, ShaderExpression right) => ShaderExpression.Binary(
        left: left,
        op: ShaderOp.Maximum,
        right: right
    );
    ...
    /// <param name="right">The second value.</param>
    /// <returns>The node.</returns>
    public static ShaderExpression Min(ShaderExpression left, ShaderExpression right) => ShaderExpression.Binary(
        left: left,
        op: ShaderOp.Minimum,
        right: right
    );
    ...
    /// <returns>The node.</returns>
    public static ShaderExpression Pow(ShaderExpression value, ShaderExpression exponent) => ShaderExpression.Binary(
        left: value,
        op: ShaderOp.Power,
        right: exponent
    );
    ...
    /// <param name="value">The value.</param>
    /// <returns>The node.</returns>
    public static ShaderExpression Saturate(ShaderExpression value) => ShaderExpression.Unary(
        op: ShaderOp.Saturate,
        value: value
    );
    ...
    /// <returns>The node.</returns>
    public static ShaderExpression Seeded(ShaderExpression position, uint seed) => ((position * ShaderExpression.Constant(
        x: 1f,
        y: 1f
    )) + ShaderExpression.Constant(
        x: 0f,
        y: 0f,
        z: 0f,
    ...
    /// <returns>The node.</returns>
    public static ShaderExpression Select(ShaderExpression condition, ShaderExpression whenTrue, ShaderExpression whenFalse) => ShaderExpression.Ternary(
        a: whenFalse,
        b: whenTrue,
        c: condition,
        op: ShaderOp.Select
    ...
    /// <param name="value">The value.</param>
    /// <returns>The node.</returns>
    public static ShaderExpression Sign(ShaderExpression value) => ShaderExpression.Unary(
        op: ShaderOp.Sign,
        value: value
    );
    ...
    /// <param name="value">The value, in radians.</param>
    /// <returns>The node.</returns>
    public static ShaderExpression Sin(ShaderExpression value) => ShaderExpression.Unary(
        op: ShaderOp.Sine,
        value: value
    );
    ...
    /// <param name="value">The value.</param>
    /// <returns>The node.</returns>
    public static ShaderExpression SmoothStep(ShaderExpression edge0, ShaderExpression edge1, ShaderExpression value) => ShaderExpression.Ternary(
        a: edge0,
        b: edge1,
        c: value,
        op: ShaderOp.SmoothStep
    );
    /// <summary>Takes the component-wise square root.</summary>
    /// <param name="value">The value.</param>
    /// <returns>The node.</returns>
    public static ShaderExpression Sqrt(ShaderExpression value) => ShaderExpression.Unary(
        op: ShaderOp.SquareRoot,
        value: value
    );
    ...
    /// <param name="value">The value.</param>
    /// <returns>The node.</returns>
    public static ShaderExpression Step(ShaderExpression edge, ShaderExpression value) => ShaderExpression.Binary(
        left: edge,
        op: ShaderOp.Step,
        right: value
    );
    ...
    /// <param name="value">The value.</param>
    /// <returns>The node.</returns>
    public static ShaderExpression Unit(ShaderExpression value) => ShaderExpression.Unary(
        op: ShaderOp.BitsToUnitFloat,
        value: value
    );
    /// <summary>Samples the lattice noise at a value's first two lanes.</summary>
    /// <param name="position">The value whose first two lanes locate the sample and whose fourth carries the seed bits.</param>
    /// <returns>The node.</returns>
    public static ShaderExpression ValueNoise2(ShaderExpression position) => ShaderExpression.Unary(
        op: ShaderOp.ValueNoise2,
        value: position
    );
}
