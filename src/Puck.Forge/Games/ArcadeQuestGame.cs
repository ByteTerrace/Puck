...
internal sealed class ArcadeQuestGame {
    ...
    private ArcadeQuestGame() {
        ...
        m_fw.States.DefineState(id: ArcadeQuestProtocol.StatePlay, emitEnter: EmitPlayEnter, emitTick: EmitPlayTick);
    }
    ...
    private void EmitPlayTick(Sm83Emitter e) {
        ...
        m_fw.Text.EmitPrintBcdQueued(bcdAddress: ArcadeQuestProtocol.Position, byteCount: 1, row: CounterRow, column: CounterColumn);
        ...
        e.StoreAToAddress(address: ArcadeQuestProtocol.WinFlag);
        m_fw.Text.EmitPrintQueued(text: m_winText, row: WinRow, column: WinColumn);
    ...
    private static IReadOnlyList<ScreenText> BuildOverlays() => [
        new ScreenText(Row: TitleRow, Column: TitleColumn, Text: "WALK RIGHT"),
        new ScreenText(Row: PromptRow, Column: PromptColumn, Text: "PRESS RIGHT 3X"),
        new ScreenText(Row: CounterRow, Column: CounterLabelColumn, Text: "POS"),
        new ScreenText(Row: CounterRow, Column: CounterColumn, Text: "00"),
    ];
    ...
    private static byte[] BuildPalette() =>
        HgbImage.EncodePalette(palette: [
            new HgbImage.Rgb(R: 0x08, G: 0x08, B: 0x18),
            new HgbImage.Rgb(R: 0x20, G: 0x10, B: 0x48),
            new HgbImage.Rgb(R: 0x60, G: 0x30, B: 0xA0),
            new HgbImage.Rgb(R: 0xF0, G: 0xC0, B: 0xF8),
        ]);
}
