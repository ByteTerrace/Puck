...
/**
 * React seam for `studioMachine` — components read the studio's state through the
 * hooks below instead of prop-drilling a machine reference. Constructing the actor (via
 * `<StudioContext.Provider options={{ input: {...} }}>`) is WorldStudio.tsx's job: it is the one place
