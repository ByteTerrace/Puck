...
/** Whether a section needs a signed-in account to show anything. */
export function sectionRequiresAccount(section: Section): boolean {
  return section === "audit" || section === "data";
}
