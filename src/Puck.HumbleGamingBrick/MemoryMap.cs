...
public static class MemoryMap {
    ...
    /// <summary>The CGB infrared communications port register (RP): bit 0 drives the IR LED, bit 1 reads received light
    /// (0 = detected) while the data-read-enable bits 7-6 are set. Color-only.</summary>
