...
public sealed partial class Ppu : IPpu, IClockedComponent, ISnapshotable, IModeSwitchable {
    ...
    // Countdowns, in dots, from the internal mode-3→0 edge to the CPU-facing memory unlocks (0 = idle; armed in
    // DrawDot from the unlock-lag constants). The internal mode still drives HDMA's horizontal-blank trigger on time;
    // only the bus gates trail.
    private int m_oamReadUnlockCountdown;
    private int m_oamWriteUnlockCountdown;
    private int m_videoRamReadUnlockCountdown;
    private int m_videoRamWriteUnlockCountdown;
    ...
    public Ppu(InterruptController interrupts, SystemMemory memory, Framebuffer framebuffer, MachineConfiguration configuration, Key1Component key1, CartridgeHeader header, DmgCompatibilityState dmgCompatibility) {
        ...
        if (!configuration.ExecutesBootRom) {
            ...
            if (m_supportsColor) {
                ...
                m_ly = (header.SupportsColor
                    ? (byte)0x90
                    : (byte)0x94
                );
                m_dot = (header.SupportsColor
                    ? 163
                    : 351
                );
                m_mode = 1;
    ...
    /// <inheritdoc/>
    // The write lock arms a machine cycle into the scan (reads lock from the top of the line), and object memory
    // reopens to WRITES for the entry-latency dots between the end of the scan and the pipeline engaging (the
    ...
    public void Tick() {
        ...
        // The trailing memory unlocks are pure countdowns: the bus gates read them as "still blocked" until they hit
        // zero, so nothing further applies here.
        if (m_oamReadUnlockCountdown > 0) {
            --m_oamReadUnlockCountdown;
        }

        if (m_oamWriteUnlockCountdown > 0) {
            --m_oamWriteUnlockCountdown;
        }

        if (m_videoRamReadUnlockCountdown > 0) {
            --m_videoRamReadUnlockCountdown;
        }

        if (m_videoRamWriteUnlockCountdown > 0) {
            --m_videoRamWriteUnlockCountdown;
        }
        ...
        switch (address) {
            case MemoryMap.LcdControl:
                ...
                if (
                    ...
                    m_polledMode0Countdown = 0;
                    m_irqMode0Countdown = 0;
                    m_oamReadUnlockCountdown = 0;
                    m_oamWriteUnlockCountdown = 0;
                    m_videoRamReadUnlockCountdown = 0;
                    m_videoRamWriteUnlockCountdown = 0;
                    m_lyRegister = 0;
                    m_lyForComparison = 0;
                    m_irqMode = -1;
                    m_firstLineAfterEnable = false;
            ...
            case MemoryMap.BackgroundColorPaletteData:
                WriteColorRam(
                    ...
                    index: ref m_backgroundColorPaletteIndex,
                    value: value
                );
            ...
            case MemoryMap.ObjectColorPaletteData:
                WriteColorRam(
                    ...
                    index: ref m_objectColorPaletteIndex,
                    value: value
                );
    ...
    private void TransferState<TTransfer>(TTransfer transfer) where TTransfer : struct, IStateTransfer {
        ...
        transfer.Byte(value: ref m_lcdc);
        transfer.Byte(value: ref m_ly);
        transfer.Byte(value: ref m_lyc);
        transfer.Int32(value: ref m_mode);
        transfer.Int32(value: ref m_statMode);
        transfer.Int32(value: ref m_polledMode0Countdown);
        transfer.Int32(value: ref m_irqMode0Countdown);
        transfer.Int32(value: ref m_oamReadUnlockCountdown);
        transfer.Int32(value: ref m_oamWriteUnlockCountdown);
        transfer.Int32(value: ref m_videoRamReadUnlockCountdown);
        transfer.Int32(value: ref m_videoRamWriteUnlockCountdown);
        transfer.Byte(value: ref m_lyRegister);
        transfer.Int32(value: ref m_lyForComparison);
        transfer.Boolean(value: ref m_lycCoincidence);
        transfer.Boolean(value: ref m_lycInterruptLine);
        transfer.Int32(value: ref m_irqMode);
        transfer.Boolean(value: ref m_firstLineAfterEnable);
        transfer.Boolean(value: ref m_previousStatLine);
        transfer.Byte(value: ref m_statSelect);
        transfer.Byte(value: ref m_scrollY);
        transfer.Byte(value: ref m_scrollX);
        transfer.Byte(value: ref m_backgroundPalette);
        transfer.Byte(value: ref m_objectPalette0);
        transfer.Byte(value: ref m_objectPalette1);
        transfer.Byte(value: ref m_windowY);
        transfer.Byte(value: ref m_windowX);
        transfer.Byte(value: ref m_backgroundColorPaletteIndex);
        transfer.Byte(value: ref m_objectColorPaletteIndex);
        transfer.Block(values: m_backgroundColorRam);
        transfer.Block(values: m_objectColorRam);
        transfer.Int32(value: ref m_lcdColumn);
        transfer.Int32(value: ref m_positionInLine);
        transfer.Int32(value: ref m_mode3Delay);
        transfer.Boolean(value: ref m_duringObjectFetch);
        transfer.Int32(value: ref m_objectFetchPhase);
        transfer.Int32(value: ref m_objectFetchSlot);
        transfer.Byte(value: ref m_objectFetchTile);
        transfer.Byte(value: ref m_objectFetchFlags);
        transfer.Byte(value: ref m_objectFetchLow);
        transfer.Int32(value: ref m_fetchStep);
        transfer.Int32(value: ref m_fetchStepDot);
        transfer.Int32(value: ref m_fetchTileX);
        transfer.Int32(value: ref m_fetchTileBank);
        transfer.UInt16(value: ref m_fetchMapAddress);
        transfer.UInt16(value: ref m_fetchDataAddress);
        transfer.Byte(value: ref m_fetcherY);
        transfer.Boolean(value: ref m_firstFetchOfLine);
        transfer.Byte(value: ref m_fetchTileId);
        transfer.Byte(value: ref m_fetchAttribute);
        transfer.Byte(value: ref m_fetchDataLow);
        transfer.Byte(value: ref m_fetchDataHigh);
        transfer.Byte(value: ref m_backgroundFifoHead);
        transfer.Byte(value: ref m_backgroundFifoCount);
        transfer.Block(values: m_backgroundFifoColor);
        transfer.Block(values: m_backgroundFifoAttribute);
        transfer.Int32(value: ref m_windowLineCounter);
        transfer.Boolean(value: ref m_windowYTriggered);
        transfer.Boolean(value: ref m_windowFetching);
        transfer.Boolean(value: ref m_windowHandoverStall);
        transfer.Boolean(value: ref m_wxTriggerSuppressed);
        transfer.Int32(value: ref m_spriteCount);
        transfer.Byte(value: ref m_objectFifoHead);
        transfer.Block(values: m_objectFifoColor);
        transfer.Block(values: m_objectFifoAttribute);
        transfer.Block(values: m_objectFifoIndex);
        transfer.Block(values: m_spriteIndices);
        transfer.Block(values: m_spriteX);
        transfer.Block(values: m_spriteY);
        transfer.Block(values: m_spriteFetched);
        transfer.Boolean(value: ref m_stopBlackout);
    ...
    private void ScanSprites() {
        ...
        var height = (((m_lcdc & ObjectSize) != 0)
            ? 16
            : 8
        );
    ...
    private void DrawDot() {
        ...
        if (m_objectFetchPhase == 0) {
            ...
            if (m_wxTriggerSuppressed) {
                ...
                WindowTriggerMatches(desynced: out var desynced)
            ) {
                ++m_windowLineCounter;
        ...
        if (++m_positionInLine == ScreenWidth) {
            ...
            // Color hardware recognizes the mode-0 interrupt condition one dot earlier at single speed — the same
            // half-dot family as the polled edge gaining a dot at double speed. The Color boot handoff leaves the
    ...
    private void ObjectFetchDot() {
        ...
        switch (m_objectFetchPhase) {
            ...
            case 3:
                ...
                break;
            case 5:
                m_objectFetchLow = m_memory.ReadVideoRamBank(
                    bank: ObjectFetchBank(),
                    address: ObjectFetchAddress()
                );
    ...
    private int ObjectFetchBank() =>
        ((m_cgbNative && ((m_objectFetchFlags & AttributeTileBank) != 0))
            ? 1
            : 0
        );
    ...
    private void OverlayObjectRow(byte high) {
        ...
        for (var pixel = 0; (pixel < 8); ++pixel) {
            ...
            if (
                (m_objectFifoColor[slot] == 0) ||
                (m_cgbNative && (index < m_objectFifoIndex[slot]))
            ) {
    ...
    private bool ObjectWins(byte backgroundColor, byte backgroundAttribute, byte objectAttribute) {
        ...
        if (
            (backgroundColor != 0) &&
            ((backgroundAttribute & AttributePriority) != 0)
        ) {
            return false;
        }
        ...
        if (
            (backgroundColor != 0) &&
            ((objectAttribute & AttributePriority) != 0)
        ) {
            return false;
        }
    ...
    private uint ResolveObjectColor(byte color, byte attribute) {
        ...
        if (m_dmgCompatibility) {
            ...
            var compat = (((attribute & AttributeDmgPalette) != 0)
                ? m_compatObject1
                : m_compatObject0
            );
    ...
    private void ComputeTileAddress() {
        ...
        if (m_windowFetching) {
            mapBase = (((m_lcdc & WindowTileMap) != 0)
                ? 0x9C00
                : 0x9800
            );
            ...
            mapBase = (((m_lcdc & BackgroundTileMap) != 0)
                ? 0x9C00
                : 0x9800
            );
    ...
    private void ComputeDataAddress() {
        ...
        m_fetchTileBank = (((m_fetchAttribute & AttributeTileBank) != 0)
            ? 1
            : 0
        );
