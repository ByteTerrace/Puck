...
public enum MapperKind {
    ...
    Mmm01 = 8,
    /// <summary>The HuC1 mapper (banked RAM or infrared behind one window).</summary>
    HuC1 = 9,
    /// <summary>The HuC3 mapper (mode-selected window with a nibble-protocol real-time clock and infrared).</summary>
    HuC3 = 10,
    /// <summary>The camera cartridge (MAC-GBD) mapper.</summary>
    Camera = 11,
}
