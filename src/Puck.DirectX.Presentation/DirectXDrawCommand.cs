...
/// <c>DirectXPipelineLayout</c>), the descriptor heap and GPU table handle, optional root 32-bit constants, the instanced draw parameters, and a sequence key that preserves
