...
/// (through which a stage resolves the neutral GPU services), the shared GPU device the offscreen host published, and
/// the directory stages write their artifacts to. A lazily-created LUID-matched Direct3D 12 device for the
/// cross-backend tier is added here when that tier lands.</summary>
