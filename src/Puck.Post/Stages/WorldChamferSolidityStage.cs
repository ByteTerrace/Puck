...
internal sealed class WorldChamferSolidityStage : IPostStage {
    ...
    internal static SdfProgram BuildChamferedBladesScene() {
        ...
        return builder
            ...
            .Box(halfExtents: new Vector3(0.33f, 0.33f, 0.07f), round: 0f, material: brass)
            .Rotate(rotation: Quaternion.CreateFromAxisAngle(axis: Vector3.UnitZ, angle: (35f * (MathF.PI / 180f))))
            .Box(halfExtents: new Vector3(0.33f, 0.33f, 0.07f), round: 0f, material: brass, blend: SdfBlendOp.ChamferUnion, smooth: 0.16f)
            .Build();
    }
    ...
    private static PostStageOutcome RunCore(PostContext context) {
        ...
        var artifactPath = Path.Combine(context.ArtifactsDirectory, "world-chamfer-solidity.png");
