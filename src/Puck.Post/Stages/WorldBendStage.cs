...
internal sealed class WorldBendStage : IPostStage {
    ...
    internal static SdfProgram BuildBendScene() {
        ...
        return builder
            ...
            .BendY(rate: 1.1f)
            .Box(halfExtents: new Vector3(x: 0.4f, y: 1.0f, z: 0.4f), round: 0.06f, material: brick)
            ...
            .ResetPoint()
            .Translate(offset: new Vector3(x: 0.1f, y: 1.0f, z: 0f))
            .BendZ(rate: 1.1f)
            .Box(halfExtents: new Vector3(x: 0.4f, y: 1.0f, z: 0.4f), round: 0.06f, material: teal)
            ...
            .ResetPoint()
            .Translate(offset: new Vector3(x: 2.3f, y: 0.35f, z: -0.6f))
            .BendY(rate: 0.9f)
            .Capsule(endpoint: new Vector3(x: 0f, y: 1.2f, z: 0f), radius: 0.28f, material: honey)
            .Build();
    }
