...
internal sealed class WorldScaleStage : IPostStage {
    ...
    internal static SdfProgram BuildScaleScene() {
        ...
        return builder
            ...
            .ResetPoint()
            .Translate(offset: new Vector3(x: -2.2f, y: 0.55f, z: 0f))
            .Scale(scale: new Vector3(x: 1.6f, y: 0.7f, z: 1.0f))
            .Box(halfExtents: new Vector3(x: 0.5f, y: 0.5f, z: 0.5f), round: 0.05f, material: brick)
            ...
            .ResetPoint()
            .Translate(offset: new Vector3(x: 0.1f, y: 0.85f, z: 0f))
            .Scale(scale: new Vector3(x: 0.6f, y: 1.4f, z: 0.6f))
            .Sphere(radius: 0.6f, material: teal)
            // A torus squashed thin in Z: a wrong Z reciprocal breaks the ring's silhouette.
            .ResetPoint()
            .Translate(offset: new Vector3(x: 2.2f, y: 0.5f, z: 0f))
            .Scale(scale: new Vector3(x: 1.3f, y: 1.3f, z: 0.5f))
