...
internal sealed class WorldSmoothIntersectionStage : IPostStage {
    ...
    internal static SdfProgram BuildSmoothIntersectionScene() {
        ...
        return builder
            ...
            .Translate(offset: new Vector3(x: -1.75f, y: 0.9f, z: 0f))
            .Sphere(radius: 0.62f, material: copper)
            .ResetPoint()
            .Translate(offset: new Vector3(x: -1.25f, y: 0.9f, z: 0f))
            ...
            .ResetPoint()
            .PushField(compose: SdfBlendOp.Union)
            .Translate(offset: new Vector3(x: 1.6f, y: 0.62f, z: 0f))
            .Box(halfExtents: new Vector3(x: 0.5f, y: 0.5f, z: 0.5f), round: 0f, material: violet)
            .ResetPoint()
            .Translate(offset: new Vector3(x: 1.6f, y: 0.62f, z: 0f))
