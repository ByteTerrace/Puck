...
public interface IGameInput {
    ...
    [return: MarshalAs(UnmanagedType.U1)][PreserveSig] bool UnregisterCallback(ulong callbackToken, ulong timeoutInMicroseconds);
}
...
public interface IGameInputReading {
    ...
    [return: MarshalAs(UnmanagedType.U1)][PreserveSig] bool GetRawReport(out nint report);
    ...
    [return: MarshalAs(UnmanagedType.U1)][PreserveSig] bool GetMouseState(nint state);
...
public interface IGameInputDevice {
    ...
    [return: MarshalAs(UnmanagedType.U1)][PreserveSig] bool IsForceFeedbackMotorPoweredOn(uint motorIndex);
