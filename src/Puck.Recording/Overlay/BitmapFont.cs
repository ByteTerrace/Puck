...
/// <summary>
/// A compact embedded 8x8 monospace ASCII font (printable range U+0020..U+007E), rendered at integer scale so
/// overlay text stays crisp (nearest-neighbor block pixels, no filtering blur) at any requested cap height. It is
/// the self-contained v1 glyph path: no external atlas, no cross-project asset dependency, deterministic. Each
/// glyph is eight row bytes; bit <c>i</c> (value <c>1 &lt;&lt; i</c>) of a row is the pixel in column <c>i</c>,
...
internal static class BitmapFont {
    ...
    /// <param name="row">The row, from the top.</param>
