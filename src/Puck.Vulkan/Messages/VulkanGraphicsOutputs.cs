...
/// and how it tests and writes the render pass's depth attachment.
/// </summary>
...
public readonly record struct VulkanGraphicsOutputs(uint ColorAttachmentCount, bool AlphaBlend, uint? DepthCompareOp = null);
