    ...
    private DevicePointers GetPointers(nint deviceHandle) {
        return m_pointers.GetOrAdd(
            ...
            valueFactory: static handle => {
                ...
                var getBufferDeviceAddress = VulkanProcResolver.ResolveOptionalDeviceProc(
                    deviceHandle: handle,
                    functionName: "vkGetBufferDeviceAddress"u8
                );

                if (0 == getBufferDeviceAddress) {
                    getBufferDeviceAddress = VulkanProcResolver.ResolveOptionalDeviceProc(
                        deviceHandle: handle,
                        functionName: "vkGetBufferDeviceAddressKHR"u8
                    );
                }
                ...
                return new DevicePointers {
                    CreateAccelerationStructure = ((delegate* unmanaged[Cdecl]<nint, in VkAccelerationStructureCreateInfoKhr, nint, out nint, VkResult>)VulkanProcResolver.ResolveOptionalDeviceProc(
                    deviceHandle: handle,
                    functionName: "vkCreateAccelerationStructureKHR"u8
                )),
                    DestroyAccelerationStructure = ((delegate* unmanaged[Cdecl]<nint, nint, nint, void>)VulkanProcResolver.ResolveOptionalDeviceProc(
                    deviceHandle: handle,
                    functionName: "vkDestroyAccelerationStructureKHR"u8
                )),
                    GetAccelerationStructureBuildSizes = ((delegate* unmanaged[Cdecl]<nint, uint, nint, nint, nint, void>)VulkanProcResolver.ResolveOptionalDeviceProc(
                    deviceHandle: handle,
                    functionName: "vkGetAccelerationStructureBuildSizesKHR"u8
                )),
                    GetAccelerationStructureDeviceAddress = ((delegate* unmanaged[Cdecl]<nint, in VkAccelerationStructureDeviceAddressInfoKhr, ulong>)VulkanProcResolver.ResolveOptionalDeviceProc(
                    deviceHandle: handle,
                    functionName: "vkGetAccelerationStructureDeviceAddressKHR"u8
                )),
                    CmdBuildAccelerationStructures = ((delegate* unmanaged[Cdecl]<nint, uint, nint, nint, void>)VulkanProcResolver.ResolveOptionalDeviceProc(
                    deviceHandle: handle,
                    functionName: "vkCmdBuildAccelerationStructuresKHR"u8
                )),
