...
public sealed class FontAtlasGenerationRequest {
    /// <summary>Gets the cooperative cancellation token for this generation job.</summary>
    ...
    /// <summary>Gets the whole-job resource ceilings. A refused or cancelled job returns no partial atlas.</summary>
    public FontAtlasGenerationLimits Limits { get; init; } = new();
