...
public enum WorldConstructShape {
    ...
    Row,
    /// <summary>A keyword-led declaration — a name, an optional reference, zero or more <c>name(args)</c>
    /// modifiers, and an optional body: <c>table hp capacity(8) { }</c>.</summary>
    Declaration,
