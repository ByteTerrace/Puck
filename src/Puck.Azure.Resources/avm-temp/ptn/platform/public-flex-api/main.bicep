...
module storageAccountPrivate 'br/public:avm/res/storage/storage-account:0.33.0' = {
  params: {
    accessTier: 'Hot'
...
module storageAccountPublic 'br/public:avm/res/storage/storage-account:0.33.0' = [for account in storage.public: {
  params: {
    accessTier: 'Hot'
    allowBlobPublicAccess: false
    allowCrossTenantReplication: false
