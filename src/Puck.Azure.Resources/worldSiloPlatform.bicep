...
module world 'ts/bvm:ptn_platform_world-silo:0.0.4' = {
  params: { configuration: configuration, owner: identity.outputs.principalId, publishingPrincipalId: publishingPrincipalId, storageAccountName: storageAccountName, registryName: registryName }
}
...
output worldSiloConfiguration worldSiloConfigType = configuration
