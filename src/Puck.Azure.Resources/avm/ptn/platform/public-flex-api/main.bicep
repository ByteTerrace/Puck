...
module functionApplication 'br/public:avm/res/web/site:0.24.0' = {
  params: {
...
module functionApplication_applicationInsights 'br/public:avm/res/insights/component:0.8.0' = {
  params: {
    applicationType: 'web'
    diagnosticSettings: []
...
module functionApplication_userAssignedIdentity 'br/public:avm/res/managed-identity/user-assigned-identity:0.6.0' = {
  params: {
    enableTelemetry: enableTelemetry
...
module storageAccountPrivate 'br/public:avm/res/storage/storage-account:0.33.1' = {
  params: {
    accessTier: 'Hot'
    ...
    networkAcls: {
      ...
      virtualNetworkRules: (forcePrivateNetworking
        ? []
        : map(
            union([function.servicePlan.subnetResourceId], (storage.networking.?additionalSubnetResourceIds ?? [])),
            subnetResourceId => {
              action: 'Allow'
              id: subnetResourceId
            }
...
module storageAccountPublic 'br/public:avm/res/storage/storage-account:0.33.1' = [
  for account in storage.public: {
    params: {
      accessTier: 'Hot'
      allowBlobPublicAccess: false
      allowCrossTenantReplication: false
...
resource storageAccountPublic_blobEventsTopic 'Microsoft.EventGrid/systemTopics@2025-07-15-preview' = [
...
resource storageAccountPublic_blobEventsSubscription 'Microsoft.EventGrid/systemTopics/eventSubscriptions@2025-07-15-preview' = [
  for (account, index) in storage.public: {
      ...
      deliveryWithResourceIdentity: {
        destination: {
          ...
          properties: {
            ...
            // A tenant GUID, not a resource ID.
