...
/// persisted format for a caller to confuse it with — the reason this stays a static kernel family
...
/// </remarks>
public static class FixedSymmetricSolve {
    ...
    internal static bool TryInvertSymmetric3(
        ...
        Debug.Assert(
            ...
            message: "TryInvertSymmetric3 requires a non-negative output fraction shift."
        );

        var groupMax = Max(
            v0: FusedArithmetic.RawMagnitude(value: a),
            v1: FusedArithmetic.RawMagnitude(value: b),
            v2: FusedArithmetic.RawMagnitude(value: c),
            v3: FusedArithmetic.RawMagnitude(value: d),
            v4: FusedArithmetic.RawMagnitude(value: e),
            v5: FusedArithmetic.RawMagnitude(value: f)
        );
        ...
        var sa = FixedVectorMath.ScaleRaw(
            shift: shift,
            value: a
        );
        var sb = FixedVectorMath.ScaleRaw(
            shift: shift,
            value: b
        );
        var sc = FixedVectorMath.ScaleRaw(
            shift: shift,
            value: c
        );
        var sd = FixedVectorMath.ScaleRaw(
            shift: shift,
            value: d
        );
        var se = FixedVectorMath.ScaleRaw(
            shift: shift,
            value: e
        );
        var sf = FixedVectorMath.ScaleRaw(
            shift: shift,
            value: f
        );

        var det = Determinant3(
            a: sa,
            b: sb,
            c: sc,
            d: sd,
        ...
        var okA = TryFinishRatio(
            denominator: det,
            fractionBitCount: fractionBitCount,
            numerator: adjugate.C11,
            result: out var ra
        );
        var okB = TryFinishRatio(
            denominator: det,
            fractionBitCount: fractionBitCount,
            numerator: adjugate.C12,
            result: out var rb
        );
        var okC = TryFinishRatio(
            denominator: det,
            fractionBitCount: fractionBitCount,
            numerator: adjugate.C13,
            result: out var rc
        );
        var okD = TryFinishRatio(
            denominator: det,
            fractionBitCount: fractionBitCount,
            numerator: adjugate.C22,
            result: out var rd
        );
        var okE = TryFinishRatio(
            denominator: det,
            fractionBitCount: fractionBitCount,
            numerator: adjugate.C23,
            result: out var re
        );
        var okF = TryFinishRatio(
            denominator: det,
            fractionBitCount: fractionBitCount,
            numerator: adjugate.C33,
            result: out var rf
        );
    ...
    internal static bool TrySolveSymmetric2(long a, long b, long d, long rhsX, long rhsY, int outputFractionShift, out long x, out long y) {
        ...
        var groupMax = Max(
            v0: FusedArithmetic.RawMagnitude(value: a),
            v1: FusedArithmetic.RawMagnitude(value: b),
            v2: FusedArithmetic.RawMagnitude(value: d),
            v3: FusedArithmetic.RawMagnitude(value: rhsX),
            v4: FusedArithmetic.RawMagnitude(value: rhsY)
        );
        ...
        // the type's remarks.
        var rawDeterminant = FusedArithmetic.AddProducts(
            firstLeft: a,
            firstRight: d,
            secondLeft: b,
            secondRight: b,
        ...
        var srx = FixedVectorMath.ScaleRaw(
            shift: shift,
            value: rhsX
        );
        var sry = FixedVectorMath.ScaleRaw(
            shift: shift,
            value: rhsY
        );

        var det = FusedArithmetic.AddProducts(
            firstLeft: sa,
            firstRight: sd,
            secondLeft: sb,
            secondRight: sb,
        ...
        var nx = FusedArithmetic.AddProducts(
            firstLeft: sd,
            firstRight: srx,
            secondLeft: sb,
            secondRight: sry,
        ...
        var ny = FusedArithmetic.AddProducts(
            firstLeft: sa,
            firstRight: sry,
            secondLeft: sb,
            secondRight: srx,
        ...
        var okX = TryFinishRatio(
            denominator: det,
            fractionBitCount: outputFractionShift,
            numerator: nx,
            result: out var rx
        );
        var okY = TryFinishRatio(
            denominator: det,
            fractionBitCount: outputFractionShift,
            numerator: ny,
            result: out var ry
    ...
    internal static bool TrySolveSymmetric3(
        ...
        Debug.Assert(
            condition: (outputFractionShift >= 0),
            message: "TrySolveSymmetric3 requires a non-negative output fraction shift."
        );
        ...
        var groupMax = Max(
            ...
            v4: FusedArithmetic.RawMagnitude(value: e),
            v5: FusedArithmetic.RawMagnitude(value: f),
            v6: FusedArithmetic.RawMagnitude(value: rhsX),
            v7: FusedArithmetic.RawMagnitude(value: rhsY),
            v8: FusedArithmetic.RawMagnitude(value: rhsZ)
        );
        ...
        var srz = FixedVectorMath.ScaleRaw(
            shift: shift,
            value: rhsZ
        );
    ...
    private static (bool Negative, UInt128 Magnitude) Accumulate((bool Negative, UInt128 Magnitude) accumulator, (bool Negative, UInt128 Magnitude) term, bool subtract) =>
        FusedArithmetic.CombineSigned(
            firstMagnitude: accumulator.Magnitude,
            firstNegative: accumulator.Negative,
            secondMagnitude: term.Magnitude,
            secondNegative: term.Negative ^ subtract
        );
    ...
    private static (
        ...
        C11: FusedArithmetic.AddProducts(
        firstLeft: d,
        firstRight: f,
        secondLeft: e,
        secondRight: e,
        ...
        C12: FusedArithmetic.AddProducts(
        firstLeft: c,
        firstRight: e,
        secondLeft: b,
        secondRight: f,
        ...
        C13: FusedArithmetic.AddProducts(
        firstLeft: b,
        firstRight: e,
        secondLeft: c,
        secondRight: d,
        ...
        C22: FusedArithmetic.AddProducts(
        firstLeft: a,
        firstRight: f,
        secondLeft: c,
        secondRight: c,
        ...
        C23: FusedArithmetic.AddProducts(
        firstLeft: b,
        firstRight: c,
        secondLeft: a,
        secondRight: e,
        ...
        C33: FusedArithmetic.AddProducts(
        firstLeft: a,
        firstRight: d,
        secondLeft: b,
        secondRight: b,
    ...
    private static (bool Negative, UInt128 Magnitude) Determinant3(long a, long b, long c, long d, long e, long f) {
        ...
        det = Accumulate(
            accumulator: det,
            subtract: false,
            term: (bce.Negative, (bce.Magnitude << 1))
        );
        det = Accumulate(
            accumulator: det,
            term: TripleProduct(
    ...
    private static (bool Negative, UInt128 Magnitude) TripleProduct(long left, long middle, long right) {
        var pair = FusedArithmetic.Product(
            left: left,
            right: middle
        );
    ...
    private static bool TryFinishRatio(
        ...
        if (!FusedArithmetic.TryDivideMagnitudeRounded(
            ...
            fractionBitCount: fractionBitCount,
            numeratorMagnitude: numerator.Magnitude,
        ...
        return FusedArithmetic.TryNarrowSignedMagnitude(
            magnitude: magnitude,
    ...
    public static bool TryApplySymmetric2(
        ...
        var shift = FusedArithmetic.MixedScaleShift(
            first: fractionBitsMatrix,
            fractionBitsOut: fractionBitsOut,
            second: fractionBitsVector
        );
        var nx = FusedArithmetic.AddProducts(
            firstLeft: a,
            firstRight: vX,
        ...
        var okX = TryFinishScaled(
            result: out var rx,
            shift: shift,
            value: nx
        );
        var okY = TryFinishScaled(
            result: out var ry,
            shift: shift,
            value: ny
        );
    ...
    public static bool TryApplySymmetric3(
        ...
        var nx = Accumulate(
            accumulator: FusedArithmetic.AddProducts(
                firstLeft: a,
                firstRight: vX,
                secondLeft: b,
                secondRight: vY
            ),
            term: FusedArithmetic.Product(
                left: c,
                right: vZ
            ),
            subtract: false
    ...
    public static bool TryInvertSymmetric2(long a, long b, long d, int outputFractionShift, out long invA, out long invB, out long invD) {
        Debug.Assert(
            condition: (outputFractionShift >= 0),
            message: "TryInvertSymmetric2 requires a non-negative output fraction shift."
        );
        ...
        var okA = TryFinishRatio(
            numerator: SignedPair(value: sd),
            denominator: det,
            fractionBitCount: fractionBitCount,
            result: out var ra
        );
        var okB = TryFinishRatio(
            numerator: NegatedSignedPair(value: sb),
            denominator: det,
            fractionBitCount: fractionBitCount,
            result: out var rb
        );
        var okD = TryFinishRatio(
            numerator: SignedPair(value: sa),
            denominator: det,
            fractionBitCount: fractionBitCount,
            result: out var rd
        );
