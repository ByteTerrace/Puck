...
public readonly record struct UnitFraction32(uint Value)
    : IComparable,
      IComparable<UnitFraction32>,
      IComparisonOperators<UnitFraction32, UnitFraction32, bool>,
      IAdditionOperators<UnitFraction32, UnitFraction32, UnitFraction32>,
      ISubtractionOperators<UnitFraction32, UnitFraction32, UnitFraction32>,
      IMultiplyOperators<UnitFraction32, UnitFraction32, UnitFraction32>,
      IDivisionOperators<UnitFraction32, UnitFraction32, UnitFraction32>,
      IModulusOperators<UnitFraction32, UnitFraction32, UnitFraction32>,
      IBitwiseOperators<UnitFraction32, UnitFraction32, UnitFraction32>,
      IShiftOperators<UnitFraction32, int, UnitFraction32>,
      IMinMaxValue<UnitFraction32>,
    ...
    public static explicit operator double(UnitFraction32 value) =>
    ...
    public static UnitFraction32 operator ~(UnitFraction32 value) =>
    ...
    /// <returns>The sum <c><paramref name="x"/> + <paramref name="y"/></c>. Use <see cref="AddSaturating(UnitFraction32, UnitFraction32)"/> to clamp instead of wrap.</returns>
    public static UnitFraction32 operator +(UnitFraction32 x, UnitFraction32 y) =>
    ...
    /// <returns>The difference <c><paramref name="x"/> − <paramref name="y"/></c>. Use <see cref="SubtractSaturating(UnitFraction32, UnitFraction32)"/> to clamp instead of wrap.</returns>
    public static UnitFraction32 operator -(UnitFraction32 x, UnitFraction32 y) =>
        new(Value: unchecked((x.Value - y.Value)));
    ...
    public static UnitFraction32 operator *(UnitFraction32 x, UnitFraction32 y) {
        ...
        return new(Value: ((uint)FixedPointRounding.RoundHalfToEven(
            remainder: remainder,
            threshold: RawHalf,
            truncated: truncated
        )));
    ...
    /// <returns><paramref name="value"/> with its raw bits shifted left, wrapping on overflow. The carrier is a thirty-two-bit word, so <paramref name="shiftAmount"/> acts MODULO THIRTY-TWO — the mask is 31: an amount of thirty-two returns <paramref name="value"/> unchanged, and a negative amount shifts by its masked residue.</returns>
    public static UnitFraction32 operator <<(UnitFraction32 value, int shiftAmount) =>
    ...
    /// <returns><paramref name="value"/> with its raw bits shifted right. Because the storage is unsigned, this is equivalent to the unsigned shift <c>&gt;&gt;&gt;</c>. The carrier is a thirty-two-bit word, so <paramref name="shiftAmount"/> acts MODULO THIRTY-TWO — the mask is 31: an amount of thirty-two returns <paramref name="value"/> unchanged, and a negative amount shifts by its masked residue.</returns>
    public static UnitFraction32 operator >>(UnitFraction32 value, int shiftAmount) =>
    ...
    /// <param name="value">The value to shift.</param>
    /// <param name="shiftAmount">The number of bit positions to shift right.</param>
    /// <returns><paramref name="value"/> with its raw bits shifted right. The carrier is a thirty-two-bit word, so <paramref name="shiftAmount"/> acts MODULO THIRTY-TWO — the mask is 31: an amount of thirty-two returns <paramref name="value"/> unchanged, and a negative amount shifts by its masked residue.</returns>
    public static UnitFraction32 operator >>>(UnitFraction32 value, int shiftAmount) =>
        new(Value: (value.Value >>> shiftAmount));
    ...
    public static bool operator <(UnitFraction32 x, UnitFraction32 y) =>
        (x.Value < y.Value);
