...
public readonly partial record struct FixedQ4816(long Value)
    ...
    internal const long SinPolyC3Q60 = -228754266787073L;
    ...
    internal const long CosPolyC3Q60 = -1601279867509510L;
    internal const long CosPolyC4Q60 = 28594283348384L;
    ...
    internal const long Exp2PolyC3Q62 = 255967521894832113L;
    internal const long Exp2PolyC4Q62 = 44355791529079737L;
    ...
    internal static ReadOnlySpan<ulong> Log2InverseTableQ62 => [
    ...
    internal static ReadOnlySpan<ulong> Log2TableQ61 => [
    ...
    internal static ReadOnlySpan<long> AtanDerivative1TableQ61 => [
    ...
    internal static ReadOnlySpan<long> AtanDerivative2TableQ61 => [
    ...
    internal static ReadOnlySpan<long> AtanDerivative3TableQ61 => [
    ...
    [VerifiedCode("fixed-q4816.negate", Basis = "exact-by-construction")]
    ...
    [VerifiedCode("fixed-q4816.negate-checked", Basis = "exact-by-construction")]
    ...
    [VerifiedCode("fixed-q4816.increment", Basis = "exact-by-construction")]
    public static FixedQ4816 operator ++(FixedQ4816 value) =>
    ...
    [VerifiedCode("fixed-q4816.decrement", Basis = "exact-by-construction")]
    public static FixedQ4816 operator --(FixedQ4816 value) =>
        new(Value: unchecked((value.Value - RawOne)));
    ...
    [VerifiedCode("fixed-q4816.add", Basis = "exact-by-construction")]
    ...
    [VerifiedCode("fixed-q4816.subtract", Basis = "exact-by-construction")]
    public static FixedQ4816 operator -(FixedQ4816 x, FixedQ4816 y) =>
        new(Value: unchecked((x.Value - y.Value)));
    ...
    /// ~2⁻⁴³. The inverse of <see cref="Log2"/>.</remarks>
    ...
    public static FixedQ4816 Pow(FixedQ4816 x, FixedQ4816 y) {
        ...
        // not need to be: only the exponents 0 and 1 have representable answers that are not a gate's, and every
        // other whole exponent either overflows (|2^47|^n from n = 2 up) or underflows (2^-47n at every negative n,
        // far below half of Epsilon).
        return ((exponent == 0L)
            ? One
            : ((exponent < 0L)
                ? Zero
    ...
    // parity decided. Keeping the sign OUT of the arithmetic is what lets every saturation answer carry it.
    private static FixedQ4816 PowMagnitude(FixedQ4816 x, FixedQ4816 y, bool whole, bool negativeResult) {
        var exponent = (y.Value >> FractionBitCount);

        if (whole) {
            // The identity exponents bypass every gate: their answers are exact — One, the base itself — or the
            // divide's single correctly-rounded inverse, so no estimate may be allowed to saturate them.
            if (exponent == 0L) {
                return One;
            }
