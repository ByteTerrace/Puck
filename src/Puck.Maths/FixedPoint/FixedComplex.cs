...
public readonly record struct FixedComplex(FixedQ4816 Real, FixedQ4816 Imaginary)
    ...
    public static FixedComplex operator *(FixedComplex left, FixedComplex right) {
        ...
        var combinedMagnitude = FusedArithmetic.RawMagnitude(value: left.Real.Value) |
                                 FusedArithmetic.RawMagnitude(value: left.Imaginary.Value) |
                                 FusedArithmetic.RawMagnitude(value: right.Real.Value) |
                                 FusedArithmetic.RawMagnitude(value: right.Imaginary.Value);
