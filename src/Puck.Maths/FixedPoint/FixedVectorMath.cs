...
internal static class FixedVectorMath {
    ...
    internal static (long X, long Y) Normalize(long x, long y) {
        var max = Math.Max(val1: RawMagnitude(value: x), val2: RawMagnitude(value: y));
    ...
    internal static (long X, long Y, long Z) Normalize(long x, long y, long z) {
        var max = Math.Max(val1: RawMagnitude(value: x), val2: Math.Max(val1: RawMagnitude(value: y), val2: RawMagnitude(value: z)));
    ...
    internal static (long X, long Y, long Z, long W) Normalize(long x, long y, long z, long w) {
        var max = Math.Max(
            val1: Math.Max(val1: RawMagnitude(value: x), val2: RawMagnitude(value: y)),
            val2: Math.Max(val1: RawMagnitude(value: z), val2: RawMagnitude(value: w))
        );
    ...
    private static long NormalizeComponent(long value, ulong denominator) =>
        DivideBySquaredSum(value: value, squaredSum: ((UInt128)denominator));
