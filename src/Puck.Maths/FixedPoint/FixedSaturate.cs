...
public static class FixedSaturate {
    ...
    public static long ToInt64(Int128 value) => (
        (value <= long.MinValue)
            ? long.MinValue
            : ((value >= long.MaxValue)
                ? long.MaxValue
    ...
    public static FixedQ4816 Add(FixedQ4816 left, FixedQ4816 right) => FixedQ4816.FromRawBits(
