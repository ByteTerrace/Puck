...
public readonly record struct ModularTransform
    ...
    public ModularTransform Inverse =>
        new(a: D, b: checked(-B), c: checked(-C), d: A);
    ...
    public static ModularTransform operator *(ModularTransform left, ModularTransform right) =>
        new(
            a: MultiplyAdd(left: left.A, right: right.A, otherLeft: left.B, otherRight: right.C),
            b: MultiplyAdd(left: left.A, right: right.B, otherLeft: left.B, otherRight: right.D),
            c: MultiplyAdd(left: left.C, right: right.A, otherLeft: left.D, otherRight: right.C),
            d: MultiplyAdd(left: left.C, right: right.B, otherLeft: left.D, otherRight: right.D)
        );
    ...
    public static GaussReduction GaussReduce(long a, long b, long c) {
        ...
        if ((0L >= c) || ((UInt128)((Int128)b * b) >= (((UInt128)(ulong)a * (ulong)c) << 2))) {
            throw new ArgumentOutOfRangeException(
                paramName: nameof(b),
    ...
    private ModularTransform LeftTranslate(long amount) =>
        ...
        new(
            a: MultiplyAdd(left: amount, right: C, otherLeft: 1L, otherRight: A),
            b: MultiplyAdd(left: amount, right: D, otherLeft: 1L, otherRight: B),
            c: C,
            d: D
        );
