...
public readonly record struct BinaryField<T> where T : IBinaryInteger<T>, IUnsignedNumber<T> {
    ...
    public T Exponentiate(T value, ulong exponent) {
        ...
        return BinaryFieldKernels.Exponentiate(value: value, exponent: exponent, degree: Degree, tail: ReductionTail);
    }
    ...
    public bool IsReduced(T value) {
        ...
        return ((BinaryFieldKernels.CarrierBitCount<T>() == Degree) || (T.Zero == (value >>> Degree)));
    }
    ...
    public T Multiply(T left, T right) {
        ...
        return BinaryFieldKernels.Multiply(left: left, right: right, degree: Degree, tail: ReductionTail);
    }
    ...
    public T Reduce(T value) {
        ...
        return BinaryFieldKernels.ReduceWide(low: value, high: T.Zero, degree: Degree, tail: ReductionTail);
    }
    ...
    public T Square(T value) {
        ...
        return BinaryFieldKernels.Multiply(left: value, right: value, degree: Degree, tail: ReductionTail);
    }
    ...
    public T SquareRoot(T value) {
        ...
        return BinaryFieldKernels.SquareRoot(value: value, degree: Degree, tail: ReductionTail);
    }
    ...
    private static void ThrowUninitialized() =>
        throw new InvalidOperationException(
            message: "The binary field is default-initialized; construct it with BinaryField<T>.Create or BinaryField<T>.FromModulus before using it."
        );
    ...
    private static BinaryField<T> CreateCore(int degree, T reductionTail, string degreeParamName, string tailParamName) {
        ...
        ArgumentOutOfRangeException.ThrowIfLessThan(value: degree, other: 1, paramName: degreeParamName);
        ArgumentOutOfRangeException.ThrowIfGreaterThan(value: degree, other: width, paramName: degreeParamName);
