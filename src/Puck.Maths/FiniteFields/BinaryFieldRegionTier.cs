...
/// in <c>BinaryFieldKernels.TryMultiplyAccumulateRegionByte</c> and <c>BinaryFieldKernels.TryMultiplyAccumulateRegionWide</c>,
/// the sixteen-bit ladder over the three affine tiers; this type only names the rungs. Each rung is a
