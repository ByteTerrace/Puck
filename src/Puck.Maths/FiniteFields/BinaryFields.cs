...
public static class BinaryFields {
    ...
    public static readonly BinaryField<byte> Degree8 = BinaryField<byte>.Create(
        degree: 8,
        reductionTail: 0x1B
    );
    /// <summary><c>GF(2^16)</c> under <c>t^16 + t^5 + t^3 + t + 1</c>.</summary>
    public static readonly BinaryField<ushort> Degree16 = BinaryField<ushort>.Create(
        degree: 16,
        reductionTail: 0x2B
    );
    /// <summary><c>GF(2^32)</c> under <c>t^32 + t^7 + t^3 + t^2 + 1</c>.</summary>
    public static readonly BinaryField<uint> Degree32 = BinaryField<uint>.Create(
        degree: 32,
        reductionTail: 0x8DU
    );
    ...
    public static readonly BinaryField<ulong> Degree64 = BinaryField<ulong>.Create(
        degree: 64,
    ...
    public static readonly BinaryField<UInt128> Degree128 = BinaryField<UInt128>.Create(
        degree: 128,
