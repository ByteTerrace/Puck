...
public readonly record struct QuadraticExtensionField64 : IBatchInvertible<QuadraticExtensionField64.Element> {
    ...
    public static QuadraticExtensionField64 Create(PrimeField64 baseField, ulong nonSquare) {
        ArgumentOutOfRangeException.ThrowIfGreaterThanOrEqual(value: nonSquare, other: BaseModulus(baseField: baseField), paramName: nameof(nonSquare));
    ...
    public Element One {
        get {
            ...
            return new Element(A: 1UL, B: 0UL);
        }
    }
    ...
    public Element Zero {
        get {
            ...
            return new Element(A: 0UL, B: 0UL);
        }
    }
    ...
    public Element Add(Element left, Element right) {
        ...
        return new Element(A: BaseField.Add(left: left.A, right: right.A), B: BaseField.Add(left: left.B, right: right.B));
    }
    ...
    public Element Frobenius(Element value) {
        ...
        return new Element(A: value.A, B: BaseField.Negate(value: value.B));
    }
    ...
    public Element FromBase(ulong value) {
        ...
        return new Element(A: value, B: 0UL);
    }
    ...
    public Element Negate(Element value) {
        ...
        return new Element(A: BaseField.Negate(value: value.A), B: BaseField.Negate(value: value.B));
    }
    ...
    public Element Subtract(Element left, Element right) {
        ...
        return new Element(A: BaseField.Subtract(left: left.A, right: right.A), B: BaseField.Subtract(left: left.B, right: right.B));
    }
    ...
    public ulong Trace(Element value) {
        ...
        return BaseField.Add(left: value.A, right: value.A);
    }
    ...
    private static void ThrowUninitialized() =>
        throw new InvalidOperationException(
            message: "The quadratic extension is default-initialized; construct it with QuadraticExtensionField64.Create or QuadraticExtensionField64.CreateCanonical before using it."
        );
}
