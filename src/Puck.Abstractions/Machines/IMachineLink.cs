...
/// <summary>
/// A cable-linked group of <see cref="IMachineRuntime"/>s advanced as ONE deterministically interleaved unit — a LINK is
...
public interface IMachineLink : IDisposable {
    ...
    IReadOnlyList<IMachineRuntime> Machines { get; }
