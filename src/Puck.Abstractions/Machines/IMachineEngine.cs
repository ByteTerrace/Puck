...
/// <summary>
/// A factory for one kind of <see cref="IMachineRuntime"/> — the registered engine a host resolves a declared or
...
/// </summary>
public interface IMachineEngine {
    ...
    /// <summary>Constructs from validated structured configuration and host-prepared assets.</summary>
    ...
    IMachineRuntime Create(string? options, byte[]? contentBytes = null, string? savePath = null, int audioSampleRate = 0);
}
