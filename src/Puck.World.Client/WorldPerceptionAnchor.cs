...
/// Control route (<c>IWorldGrantsView.ControlRoute</c>) targeting a BODY with capture ON
/// (<c>IWorldGrantsView.RouteCapture</c>) — possession means possession: the entire perceived world follows
...
/// swap either. <c>WorldSeatContextSync.Publish</c> is the sole writer — it already reads
