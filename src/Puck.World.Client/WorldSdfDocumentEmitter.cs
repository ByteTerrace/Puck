...
/// composed as its own <see cref="ISdfSceneEmitter"/> beside <c>WorldSceneEmitter</c> (see
/// <see cref="SdfCompositionFrameSource"/> — the same live seam <c>WorldSceneEmitter</c> already exercises,
