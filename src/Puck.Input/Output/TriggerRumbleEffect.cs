...
/// normalized 0..1 intensity. Plays for <paramref name="DurationMilliseconds"/>; a duration of zero stops every
/// rumble motor immediately.
/// </summary>
/// <param name="Left">The left trigger motor intensity, 0..1.</param>
/// <param name="Right">The right trigger motor intensity, 0..1.</param>
/// <param name="DurationMilliseconds">How long the effect plays before the motors return to rest; zero stops rumble immediately.</param>
