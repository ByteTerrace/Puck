...
internal static class KeyboardSourceMap {
    ...
    public static bool TryGetSource(KeyCode key, char character, out string source) {
        source = key switch {
            ...
            >= KeyCode.Digit0 and <= KeyCode.Digit9 => InputSources.Keyboard.Digit(number: (key - KeyCode.Digit0)),
            KeyCode.Minus => InputSources.Keyboard.Minus,
            KeyCode.Equals => InputSources.Keyboard.EqualsKey,
            >= KeyCode.Numpad0 and <= KeyCode.Numpad9 => InputSources.Keyboard.NumpadDigit(number: (key - KeyCode.Numpad0)),
            KeyCode.NumpadSubtract => InputSources.Keyboard.NumpadSubtract,
            KeyCode.NumpadAdd => InputSources.Keyboard.NumpadAdd,
