...
/// <param name="Family">The admitted context family this row keys on (e.g. <c>roster</c>, <c>engagement</c>).</param>
...
/// must name a group the composed document declares.</param>
