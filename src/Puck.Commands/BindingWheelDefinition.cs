...
/// so a group without a wheel simply presents nothing.</param>
...
/// <param name="DeadZoneFraction">The visual hub radius, direct-target dead zone, and explicit-ring angle dead
/// zone as a viewport fraction. Excursion-controlled selectors use <see cref="BindingWheelExcursionDefinition.DeadZone"/>.</param>
