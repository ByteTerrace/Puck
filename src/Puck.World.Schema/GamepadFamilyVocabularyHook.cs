...
/// <see cref="GamepadButtonVocabularyHook"/> already crosses for a binding-bar slot name. The composition root
/// (<c>Puck.World</c>) wires this hook before any validator can run.
/// </summary>
