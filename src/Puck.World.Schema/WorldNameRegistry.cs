...
public sealed record WorldNameField(Type Owner, string Member, WorldNameKind Kind, WorldNameRole Role);
...
public static partial class WorldNameRegistry {
    ...
    private static readonly WorldNameField[] Fields = [
        ...
        new(typeof(ActionEffect.SetState), nameof(ActionEffect.SetState.State), WorldNameKind.State, WorldNameRole.Names),
        ...
        new(typeof(ActionEffect.AddState), nameof(ActionEffect.AddState.State), WorldNameKind.State, WorldNameRole.Names),
        ...
        new(typeof(ActionEffect.PushState), nameof(ActionEffect.PushState.State), WorldNameKind.State, WorldNameRole.Names),
        ...
        new(typeof(ActionEffect.CountdownState), nameof(ActionEffect.CountdownState.State), WorldNameKind.State, WorldNameRole.Names),
        new(typeof(ActionEffect.CountdownState), nameof(ActionEffect.CountdownState.Key), WorldNameKind.State, WorldNameRole.Key),
        new(typeof(ActionEffect.RemoveStateCell), nameof(ActionEffect.RemoveStateCell.State), WorldNameKind.State, WorldNameRole.Names),
        new(typeof(ActionEffect.RemoveStateCell), nameof(ActionEffect.RemoveStateCell.Key), WorldNameKind.State, WorldNameRole.Key),
        new(typeof(ActionEffect.ScheduleState), nameof(ActionEffect.ScheduleState.State), WorldNameKind.State, WorldNameRole.Names),
        new(typeof(ActionEffect.ScheduleState), nameof(ActionEffect.ScheduleState.Key), WorldNameKind.State, WorldNameRole.Key),
        new(typeof(ActionEffect.Generate), nameof(ActionEffect.Generate.Row), WorldNameKind.State, WorldNameRole.Names),
        new(typeof(WorldEffect.StartTimer), nameof(WorldEffect.StartTimer.State), WorldNameKind.State, WorldNameRole.Names),
        ...
        new(typeof(WorldEffect.PaintField), nameof(WorldEffect.PaintField.Field), WorldNameKind.Field, WorldNameRole.Names),
        new(typeof(WorldDecisionOption), nameof(WorldDecisionOption.Score), WorldNameKind.State, WorldNameRole.Expression),
        // State transforms.
        new(typeof(StateTransform.Observe), nameof(StateTransform.Observe.Row), WorldNameKind.State, WorldNameRole.Names),
        new(typeof(StateTransform.Transfer), nameof(StateTransform.Transfer.From), WorldNameKind.Zone, WorldNameRole.Names),
        new(typeof(StateTransform.Transfer), nameof(StateTransform.Transfer.To), WorldNameKind.Zone, WorldNameRole.Names),
        ...
        new(typeof(StateTransform.SetRay), nameof(StateTransform.SetRay.Row), WorldNameKind.State, WorldNameRole.Names),
        ...
        new(typeof(StateTransform.Shuffle), nameof(StateTransform.Shuffle.Row), WorldNameKind.State, WorldNameRole.Names),
        new(typeof(StateTransform.Shuffle), nameof(StateTransform.Shuffle.Draw), WorldNameKind.State, WorldNameRole.Names),
        new(typeof(StateTransform.SortZone), nameof(StateTransform.SortZone.Row), WorldNameKind.Zone, WorldNameRole.Names),
        new(typeof(SortKey), nameof(SortKey.Row), WorldNameKind.State, WorldNameRole.Names),
        new(typeof(StateTransform.SortKeyed), nameof(StateTransform.SortKeyed.Row), WorldNameKind.State, WorldNameRole.Names),
        new(typeof(StateTransform.WriteSet), nameof(StateTransform.WriteSet.Row), WorldNameKind.State, WorldNameRole.Names),
        ...
        new(typeof(StateTransform.BoardCombine), nameof(StateTransform.BoardCombine.Row), WorldNameKind.State, WorldNameRole.Names),
        ...
        new(typeof(StateTransform.Arrange), nameof(StateTransform.Arrange.Row), WorldNameKind.Zone, WorldNameRole.Names),
        ...
        new(typeof(StateTransform.Push), nameof(StateTransform.Push.Row), WorldNameKind.State, WorldNameRole.Names),
        new(typeof(StateTransform.ClearEnclosed), nameof(StateTransform.ClearEnclosed.Row), WorldNameKind.State, WorldNameRole.Names),
        ...
        new(typeof(WorldSearchRow), nameof(WorldSearchRow.Best), WorldNameKind.State, WorldNameRole.Names),
        ...
        new(typeof(WorldPlacementBoard), nameof(WorldPlacementBoard.Occupancy), WorldNameKind.State, WorldNameRole.Names),
        ...
        new(typeof(WorldFieldWrite), nameof(WorldFieldWrite.Field), WorldNameKind.Field, WorldNameRole.Names),
        new(typeof(WorldReaction.Diffuse), nameof(WorldReaction.Diffuse.Field), WorldNameKind.Field, WorldNameRole.Names),
        new(typeof(WorldReaction.Decay), nameof(WorldReaction.Decay.Field), WorldNameKind.Field, WorldNameRole.Names),
        new(typeof(WorldReaction.Emit), nameof(WorldReaction.Emit.Field), WorldNameKind.Field, WorldNameRole.Names),
        new(typeof(WorldReaction.Expose), nameof(WorldReaction.Expose.Field), WorldNameKind.Field, WorldNameRole.Names),
        new(typeof(WorldReaction.Expose), nameof(WorldReaction.Expose.Row), WorldNameKind.State, WorldNameRole.Names),
        new(typeof(WorldReaction.Flow), nameof(WorldReaction.Flow.Field), WorldNameKind.Field, WorldNameRole.Names),
        new(typeof(WorldReaction.Flow), nameof(WorldReaction.Flow.Over), WorldNameKind.Field, WorldNameRole.Names),
        new(typeof(WorldReaction.Flow), nameof(WorldReaction.Flow.SpillRow), WorldNameKind.State, WorldNameRole.Names),
        ...
        new(typeof(WorldHudElement), nameof(WorldHudElement.Binding), WorldNameKind.State, WorldNameRole.Binding),
        new(typeof(WorldHudElement), nameof(WorldHudElement.Template), WorldNameKind.State, WorldNameRole.Template),
        new(typeof(OverlayPredicate.State), nameof(OverlayPredicate.State.Binding), WorldNameKind.State, WorldNameRole.Binding),
        new(typeof(WorldCameraProgramOp.Dynamics), nameof(WorldCameraProgramOp.Dynamics.Row), WorldNameKind.Dynamics, WorldNameRole.Names),
        ...
        new(typeof(BindingWheelDefinition), nameof(BindingWheelDefinition.LabelRow), WorldNameKind.State, WorldNameRole.Binding),
        new(typeof(BindingWheelDefinition), nameof(BindingWheelDefinition.IconRow), WorldNameKind.State, WorldNameRole.Binding),
        new(typeof(WorldBindingBarAuthoring), nameof(WorldBindingBarAuthoring.IconRow), WorldNameKind.State, WorldNameRole.Binding),
    ];
    private static readonly WorldNameExclusion[] Exclusions = [
        ...
        new(typeof(WorldInteraction), nameof(WorldInteraction.Left), "a kit name"),
        new(typeof(WorldInteraction), nameof(WorldInteraction.Right), "a kit name"),
