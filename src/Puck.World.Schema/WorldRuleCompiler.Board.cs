...
public static partial class WorldRuleCompiler {
    private static ResolvedOperand ResolveBoardOperand(string name, string? key, string ruleName, WorldDefinition definition) {
        ...
        if (kind is not (WorldBoardQueryKind.Mask or WorldBoardQueryKind.Image or WorldBoardQueryKind.Canonical or WorldBoardQueryKind.CanonicalMask or WorldBoardQueryKind.CellOf)) {
