...
/// parse/print pair, exactly as <see cref="TokenEnumJsonConverter{T}"/> does for a closed vocabulary.
/// </summary>
/// <typeparam name="T">The validated-string value type.</typeparam>
internal abstract class TryParseStringJsonConverter<T> : JsonConverter<T>, IJsonSchemaStringConverter where T : struct {
