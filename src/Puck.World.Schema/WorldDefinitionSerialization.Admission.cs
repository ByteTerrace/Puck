...
public static partial class WorldDefinitionSerialization {
    ...
    public static WorldDefinitionAdmission DeserializeForAdmission(byte[] utf8Json, IMachineValidationCatalog machines) {
    ...
    private static WorldDefinition ParseEmbedded(byte[] utf8Json) {
