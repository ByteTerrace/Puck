...
/// <summary>An AUTHORED per-seat mode family — a document-declared name plus its admitted states, the generic
/// replacement for the engine's former hard-coded editor context family. <c>player.mode &lt;family&gt; &lt;state&gt;
/// [seat]</c> flips a seat's published state within the family; <c>Puck.World.Client.WorldContextFamilies</c>
/// context rows may then map a (family, state) pair to a binding group exactly as a built-in family does.</summary>
