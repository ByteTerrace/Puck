...
/// <summary>
/// The one object-id shape check for an authored oid field — an oid is a Guid string. Both
...
/// implementation.
/// </summary>
public static class WorldObjectId {
    /// <summary>Whether <paramref name="value"/> is a well-formed, non-empty object id.</summary>
