...
public static partial class WorldDefinitionValidator {
    ...
    private static void ValidateBoardFacet(WorldPlacementBoard? board, WorldDefinition definition, string path,
        ...
        if (WorldTopologyCompilation.Find(definition, board.Topology) is not { } topology || topology.Kind is not (TopologyKind.Grid or TopologyKind.Hex or TopologyKind.Graph or TopologyKind.Tiling)) {
