...
public static class WorldVoicePatchFactory {
    // Puck.Forge.Authoring.SynthOscillator and Puck.Audio.Mixing.SynthOscillator declare the SAME oscillator
    ...
    private static Puck.Audio.Mixing.SynthOscillator ToRuntimeOscillator(Puck.Forge.Authoring.SynthOscillator oscillator) => (oscillator switch {
        Puck.Forge.Authoring.SynthOscillator.Pulse => Puck.Audio.Mixing.SynthOscillator.Pulse,
        Puck.Forge.Authoring.SynthOscillator.Saw => Puck.Audio.Mixing.SynthOscillator.Saw,
        Puck.Forge.Authoring.SynthOscillator.Triangle => Puck.Audio.Mixing.SynthOscillator.Triangle,
        Puck.Forge.Authoring.SynthOscillator.Sine => Puck.Audio.Mixing.SynthOscillator.Sine,
        Puck.Forge.Authoring.SynthOscillator.Noise => Puck.Audio.Mixing.SynthOscillator.Noise,
    ...
    public static VoicePatch FromDocument(SynthPatchDocument document) {
        ...
        return new(
            Oscillator: ToRuntimeOscillator(oscillator: (document.Oscillator ?? Puck.Forge.Authoring.SynthOscillator.Pulse)),
