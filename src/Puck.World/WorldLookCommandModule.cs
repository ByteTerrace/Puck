...
/// <c>world.row.set</c>/<c>world.row.remove looks</c> in <see cref="WorldRowCommandModule"/>, and their
/// row-to-entity sequence through <c>world.assign looks ...</c>. A SEPARATE module from
