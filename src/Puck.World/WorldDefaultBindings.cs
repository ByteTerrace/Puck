...
internal static class WorldDefaultBindings {
    ...
    private static BindingPageEntryDefinition[] ControlPageEntries() => [
        ...
        new BindingPageEntryDefinition(
            ...
            Command: PlayerCommandModule.MoveCommand
        ),
        new BindingPageEntryDefinition(
            Source: InputSources.Gamepad.RightStick,
            Command: PlayerCommandModule.LookCommand
        ),
        new BindingPageEntryDefinition(
            Source: InputSources.Keyboard.Letter(letter: 'c'),
    ...
    private static BindingPageEntryDefinition[] HoldReleaseChannel(string source, string channel, float scale = 1f) => [
        new BindingPageEntryDefinition(
            Source: source,
            Channel: new ChannelRef.Name(Value: channel),
            Scale: scale
        ),
        new BindingPageEntryDefinition(
            Source: source,
    ...
    private static BindingPageEntryDefinition[] KeyboardMovementEntries() => [
        .. HoldReleaseChannel(
            source: InputSources.Keyboard.Letter(letter: 'w'),
            channel: ForwardChannelName,
            scale: 1f
        ),
        .. HoldReleaseChannel(
            channel: ForwardChannelName,
            scale: 1f,
            source: InputSources.Keyboard.ArrowUp
        ),
        .. HoldReleaseChannel(
            source: InputSources.Keyboard.Letter(letter: 's'),
            channel: ForwardChannelName,
            scale: -1f
        ),
        .. HoldReleaseChannel(
            channel: ForwardChannelName,
            scale: -1f,
            source: InputSources.Keyboard.ArrowDown
        ),
        .. HoldReleaseChannel(
            source: InputSources.Keyboard.Letter(letter: 'a'),
            channel: StrafeChannelName,
            scale: -1f
        ),
        .. HoldReleaseChannel(
            channel: TurnChannelName,
            scale: 1f,
            source: InputSources.Keyboard.ArrowLeft
        ),
        .. HoldReleaseChannel(
            source: InputSources.Keyboard.Letter(letter: 'd'),
            channel: StrafeChannelName,
            scale: 1f
        ),
        .. HoldReleaseChannel(
            channel: TurnChannelName,
            scale: -1f,
            source: InputSources.Keyboard.ArrowRight
        ),
        .. HoldReleaseChannel(
            source: InputSources.Keyboard.Letter(letter: 'q'),
            channel: TurnChannelName,
            scale: 1f
        ),
        .. HoldReleaseChannel(
            source: InputSources.Keyboard.Letter(letter: 'e'),
            channel: TurnChannelName,
            scale: -1f
        ),
    ];
    ...
    private static BindingWheelDefinition PlayWheel() => new(
        ...
        Rings: [
            new BindingPageDefinition(
                ...
                Entries: [
                    Sector(
                        command: EditorCommandModule.EnterCommand,
                        label: "Editor",
                        icon: "edit.place"
                    ),
                    Sector(
                    ...
                    Sector(
                        command: "player.where",
                        label: "Where",
                        icon: "action.target"
                    ),
                    Sector(
                        command: "player.channels",
                        label: "Channels",
                        icon: "edit.link"
                    ),
                    Sector(
                        command: "player.disengage",
                        label: "Disengage",
                        icon: "edit.exit"
                    ),
                ],
    ...
    private static BindingContextDefinition[] RosterContextRows() => [
        new BindingContextDefinition(
            ...
            Group: RosterGroup,
            State: WorldContextFamilies.RosterUnjoined
        ),
        new BindingContextDefinition(
            Family: WorldContextFamilies.Roster,
            Group: RosterGroup,
            State: WorldContextFamilies.RosterClaimed
        ),
        new BindingContextDefinition(
            Family: WorldContextFamilies.Roster,
            Group: RosterGroup,
            State: WorldContextFamilies.RosterPending
        ),
    ];
        ...
        return new BindingProfileDocument(
            ...
            Modifiers: [
                new BindingModifierDefinition(
                    Id: LeftTriggerModifierId,
                    Source: InputSources.Gamepad.LeftTrigger,
                    PressThreshold: TriggerPress,
                    ReleaseThreshold: TriggerRelease,
                    Label: "LT"
                ),
                new BindingModifierDefinition(
                    Id: RightTriggerModifierId,
                ...
                new BindingModifierDefinition(
                    Id: LeftControlModifierId,
                    Source: InputSources.Keyboard.ControlLeft,
                    Label: "Ctrl"
                ),
                new BindingModifierDefinition(
                    Id: RightControlModifierId,
                    Source: InputSources.Keyboard.ControlRight,
                    Label: "Ctrl"
                ),
                // The wheel hold key — one physical key, one modifier (Tab has no left/right pair to declare).
                new BindingModifierDefinition(
                    Id: TabModifierId,
                    Source: InputSources.Keyboard.Tab,
                    Label: "Tab"
                ),
            ],
            Chords: [
                ...
                new BindingChordDefinition(
                    ...
                    Page: new BindingPageDefinition(
                        ...
                        Entries: [
                            ...
                            new BindingPageEntryDefinition(
                                Source: InputSources.Keyboard.Enter,
                                Command: PlayerCommandModule.ConfirmCommand,
                                ActivateOn: CommandPhase.Started
                            ),
                            Claim(function: 1),
                            Claim(function: 2),
                            ...
                            new BindingPageEntryDefinition(
                                Source: InputSources.Gamepad.Start,
                                Command: PlayerCommandModule.CycleCommand,
                                ActivateOn: CommandPhase.Started
                            ),
                ...
                new BindingChordDefinition(
                    ...
                    Page: new BindingPageDefinition(
                        Id: ControlLeftPageId,
                        Entries: ControlPageEntries(),
                        Label: "Ctrl"
                    )
                ),
                new BindingChordDefinition(
    ...
    public static BindingPageEntryDefinition[] WheelHoldEntries(string openerSource) => [
        ...
        new BindingPageEntryDefinition(
            Source: InputSources.Gamepad.RightStick,
            Command: WorldWheelCommandModule.SelectCommand
        ),
        RingStep(
            direction: 1f,
            source: InputSources.Keyboard.ArrowUp
        ...
        new BindingPageEntryDefinition(
            Source: openerSource,
            Command: WorldWheelCommandModule.CommitCommand,
            ActivateOn: CommandPhase.Completed
        ),
    ];
}
