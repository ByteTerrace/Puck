...
[[vk::combinedImageSampler]] [[vk::binding(1, 0)]] Texture2D<float4> simulation : register(t1);
[[vk::combinedImageSampler]] [[vk::binding(1, 0)]] SamplerState simulationSampler : register(s1);
