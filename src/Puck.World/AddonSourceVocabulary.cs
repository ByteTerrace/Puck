...
/// <see cref="CommandValueKind.Axis2D"/>) an addon input act's two-lane payload record can hold — the source-kind
/// half of <see cref="WorldAffordances"/>' binding-vocabulary check.
/// </summary>
