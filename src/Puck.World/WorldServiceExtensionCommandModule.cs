...
internal sealed class WorldServiceExtensionCommandModule(Func<WorldServiceExtensions> extensions) : ICommandModule {
    public IEnumerable<CommandDefinition> GetCommands() {
        ...
        yield return CommandDefinition.WithWireArgs(name: "world.extensions",
            description: "Reads configured service operations for the acting principal; the host console also sees connection wiring and worker failures. Credentials and private configuration are never printed.",
            bindability: CommandBindability.Unbindable,
