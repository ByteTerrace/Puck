...
/// global chain bound has an author: which instance, which shape, how much. Scoped clamps are reported separately
/// by <see cref="SdfProgram.FieldScopeClamps"/>; an absent binder does not mean the program has no clamps.</summary>
