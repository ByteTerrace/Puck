...
/// <summary>
/// The one crossing from guest bytes to typed submissions — drives an <see cref="AddonInstance"/>
/// one tick and validates every returned cell against the ABI VOCABULARY: which channel kinds admit which cell
