...
// device-context type differs per backend.
public static class SurfaceReadbackCapture {
    ...
    public static Surface ReadSurface(Surface surface, IGpuDeviceContext deviceContext, ref IGpuSurfaceImport? captureImport, ref IGpuSurfaceReadback? captureReadback) {
