    ...
    public static CompiledExpressionToken[] CompileExpression(ValueExpression? expression, CellKind kind, string ruleName, string verb, RuleCompileContext context) {
        ...
        for (var index = 0; index < authored.Count; index++) {
            tokens[index] = authored[index] switch {
                ...
                ValueToken.SquareNorm => IntUnary(ExpressionOp.SquareNorm),
                ...
                ValueToken.SquareConjugate => IntUnary(ExpressionOp.SquareConjugate),
                ...
                ValueToken.MinimumExcluded => IntUnary(ExpressionOp.MinimumExcluded),
                ValueToken.IsPrime => IntUnary(ExpressionOp.IsPrime),
                ValueToken.Prime => IntUnary(ExpressionOp.Prime),
                ValueToken.Binomial => IntBinary(ExpressionOp.Binomial),
                ValueToken.Factorial => IntUnary(ExpressionOp.Factorial),
                ValueToken.CombinationRank => IntBinary(ExpressionOp.CombinationRank),
                ValueToken.CombinationUnrank => IntArity(ExpressionOp.CombinationUnrank, 3),
                ValueToken.CombinationElement => IntArity(ExpressionOp.CombinationElement, 4),
                ValueToken.PermutationRank => IntBinary(ExpressionOp.PermutationRank),
                ValueToken.PermutationUnrank => IntBinary(ExpressionOp.PermutationUnrank),
                ValueToken.PermutationElement => IntArity(ExpressionOp.PermutationElement, 3),
