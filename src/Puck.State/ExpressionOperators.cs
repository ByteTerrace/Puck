...
internal static class ExpressionOperators {
    ...
    private static readonly ExpressionOperator[] Entries = [
        ...
        Define<ValueToken.Min>(ExpressionOp.Minimum, 2, ExpressionSignature.Numeric, 2, "min", null, false),
        Define<ValueToken.Max>(ExpressionOp.Maximum, 2, ExpressionSignature.Numeric, 2, "max", null, false),
        ...
        Define<ValueToken.PopCount>(ExpressionOp.PopCount, 1, ExpressionSignature.Int, 2, "popCount", null, false),
        ...
        Define<ValueToken.Abs>(ExpressionOp.Abs, 1, ExpressionSignature.Numeric, 1, "abs", null, false),
        ...
        Define<ValueToken.PairMax>(ExpressionOp.PairMax, 1, ExpressionSignature.Int, 25, "pairMax", null, true),
        Define<ValueToken.PairMin>(ExpressionOp.PairMin, 1, ExpressionSignature.Int, 25, "pairMin", null, true),
        ...
        Define<ValueToken.Morton>(ExpressionOp.Morton, 2, ExpressionSignature.Int, 15, "morton", null, true),
        ...
        Define<ValueToken.Hilbert>(ExpressionOp.Hilbert, 3, ExpressionSignature.Int, 60, "hilbert", null, true),
        ...
        Define<ValueToken.HexIndex>(ExpressionOp.HexIndex, 2, ExpressionSignature.Int, 12, "hex", null, true),
        ...
        Define<ValueToken.SquareRoot>(ExpressionOp.SquareRoot, 1, ExpressionSignature.Numeric, 20, "sqrt", null, true),
        Define<ValueToken.Sine>(ExpressionOp.Sine, 1, ExpressionSignature.Fixed, 25, "sin", null, true),
        Define<ValueToken.Cosine>(ExpressionOp.Cosine, 1, ExpressionSignature.Fixed, 25, "cos", null, true),
        ...
        Define<ValueToken.GreatestCommonDivisor>(ExpressionOp.GreatestCommonDivisor, 2, ExpressionSignature.Int, 40, "gcd", null, true),
        Define<ValueToken.LeastCommonMultiple>(ExpressionOp.LeastCommonMultiple, 2, ExpressionSignature.Int, 45, "lcm", null, true),
        Define<ValueToken.FloorModulo>(ExpressionOp.FloorModulo, 2, ExpressionSignature.Int, 18, "mod", null, true),
        ...
        Define<ValueToken.Prime>(ExpressionOp.Prime, 1, ExpressionSignature.Int, 3, "prime", null, true),
        Define<ValueToken.Choose>(ExpressionOp.Choose, 2, ExpressionSignature.Int, 40, "choose", null, true),
