...
public abstract record ResolvedVectorTransform {
    ...
    /// <summary>Copies a vector from a source cell or literal into a target cell.</summary>
    public sealed record Copy(int TargetRowOrdinal, string TargetRowName, CellName TargetKey, int? SourceRowOrdinal, string? SourceRowName, CellName SourceKey, StateVector? SourceVector) : ResolvedVectorTransform;
