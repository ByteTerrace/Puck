...
public static class ExpressionSpelling {
    ...
    private static readonly Dictionary<string, (int Arity, Func<ValueToken> Make)> Calls = new(comparer: StringComparer.Ordinal) {
        ...
        ["hexNorm"] = (1, static () => new ValueToken.HexNorm()),
        ...
        ["hexConjugate"] = (1, static () => new ValueToken.HexConjugate()),
        ...
        ["squareNorm"] = (1, static () => new ValueToken.SquareNorm()),
        ...
        ["squareConjugate"] = (1, static () => new ValueToken.SquareConjugate()),
