...
public static partial class ExpressionArithmetic {
    ...
    private static readonly long[] Primes = BuildPrimes(count: 256);
    ...
    public static int FunctionArity(ExpressionOp operation) => ((ExpressionOperators.Find(operation: operation) is { Function: true } descriptor)
        ? descriptor.Arity
        : 0
    );
    ...
    public static bool FunctionAdmits(ExpressionOp operation, CellKind kind) => ((ExpressionOperators.Find(operation: operation) is { Function: true } descriptor) && descriptor.Admits(kind: kind));
    ...
    public static bool TryFunction(ExpressionOp operation, CellKind kind, ReadOnlySpan<long> arguments, out long value) {
        ...
        if (
            ...
            (arguments.Length != FunctionArity(operation: operation))
        ) {
            return false;
        }

        return TryValidatedFunction(
            arguments: arguments,
            kind: kind,
            operation: operation,
            value: out value
    ...
    /// <summary>Evaluates a function token whose kind and arity the compiler already proved; dynamic arithmetic
    /// domains are still checked here.</summary>
    /// <param name="operation">The function.</param>
    /// <param name="kind">The expression kind.</param>
    /// <param name="arguments">The arguments, in authored order.</param>
    /// <param name="value">The result.</param>
    /// <returns><see langword="true"/> when the function evaluated inside its domain.</returns>
    public static bool TryValidatedFunction(ExpressionOp operation, CellKind kind, ReadOnlySpan<long> arguments, out long value) {
        value = 0L;
        try {
            switch (operation) {
                ...
                case ExpressionOp.Morton: {
                        ...
                        if (
                            (x < 0L) ||
                            (y < 0L) ||
                            (x > MaxMortonComponent) ||
                            (y > MaxMortonComponent)
                        ) { return false; }
                ...
                case ExpressionOp.MortonY: {
                        ...
                        value = ((operation == ExpressionOp.MortonX)
                            ? x
                            : y
                        );
                        return true;
                ...
                case ExpressionOp.Hilbert: {
                        ...
                        if (
                            (order < 1L) ||
                            (order > MaxHilbertOrder) ||
                            (x < 0L) ||
                            (y < 0L) ||
                            (x >= (1L << ((int)order))) ||
                            (y >= (1L << ((int)order)))
                        ) { return false; }
                        value = ((long)HilbertCurve.Encode(
                            order: ((int)order),
                            x: ((uint)x),
                            y: ((uint)y)
                        ));
                ...
                case ExpressionOp.HilbertY: {
                        ...
                        if (
                            ...
                            (order > MaxHilbertOrder) ||
                            (distance < 0L) ||
                            (distance >= (1L << ((int)(order << 1))))
                        ) { return false; }
                        var (x, y) = HilbertCurve.Decode(
                            distance: ((ulong)distance),
                            order: ((int)order)
                        );
                        value = ((operation == ExpressionOp.HilbertX)
                            ? x
                            : y
                        );
                        return true;
                ...
                case ExpressionOp.HexIndex:
                    ...
                    value = HexagonalIndex.FromCoordinate(coordinate: new HexagonalCoordinate(
                        Q: ((int)arguments[0]),
                        R: ((int)arguments[1])
                    )).Value;
                    return true;
                ...
                case ExpressionOp.HexR: {
                        ...
                        value = ((operation == ExpressionOp.HexQ)
                            ? coordinate.Q
                            : coordinate.R
                        );
                        return true;
                ...
                case ExpressionOp.HexTranslate: {
                        if (
                            ...
                            !IsInt(value: arguments[1]) ||
                            !IsInt(value: arguments[2])
                        ) { return false; }
                        value = cell.Translate(displacement: new HexagonalCoordinate(
                            Q: ((int)arguments[1]),
                            R: ((int)arguments[2])
                        )).Value;
                        return true;
                ...
                case ExpressionOp.LayerSize: {
                        ...
                        value = operation switch {
                            ...
                            ExpressionOp.LayerStart => ((subject == 0L)
                            ? 0L
                            : sequence.Count(layerCount: (subject - 1L))),
                ...
                case ExpressionOp.SquareIndex:
                    ...
                    value = Puck.Maths.SquareIndex.FromCoordinate(coordinate: new SquareCoordinate(
                        X: ((int)arguments[0]),
                        Y: ((int)arguments[1])
                    )).Value;
                    return true;
                ...
                case ExpressionOp.SquareY: {
                        ...
                        value = ((operation == ExpressionOp.SquareX)
                            ? coordinate.X
                            : coordinate.Y
                        );
                        return true;
                ...
                case ExpressionOp.SquareDistance: {
                        ...
                        value = Puck.Maths.SquareIndex.Distance(
                            left: left,
                            right: right
                        );
                        return true;
                ...
                case ExpressionOp.SquareChebyshev: {
                        ...
                        value = Math.Max(
                            val1: Math.Abs(value: (((long)a.X) - b.X)),
                            val2: Math.Abs(value: (((long)a.Y) - b.Y))
                        );
                        return true;
                    }
                ...
                case ExpressionOp.SquareTranslate: {
                        ...
                        value = cell.Translate(displacement: new SquareCoordinate(
                            X: ((int)arguments[1]),
                            Y: ((int)arguments[2])
                        )).Value;
                        return true;
                ...
                case ExpressionOp.FloorModulo:
                    if (
                        (arguments[1] == 0L) ||
                        ((arguments[1] == -1L) && (arguments[0] == long.MinValue))
                    ) { return false; }
                ...
                case ExpressionOp.CycleDistance: {
                        ...
                        value = ((operation == ExpressionOp.CycleForward)
                            ? forward
                            : Math.Min(
                                val1: forward,
                                val2: (modulus - forward)
                            )
                        );
                        return true;
                    }
                case ExpressionOp.SmallestMissing:
                    value = System.Numerics.BitOperations.TrailingZeroCount(value: ~((ulong)arguments[0]));
                    return true;
                ...
                case ExpressionOp.Factorial:
                    if (!IsInt(value: arguments[0])) { return false; }
                    return TryLong(
                        count: Combinatorics.Factorial(n: ((int)arguments[0])),
                        value: out value
                    );
                case ExpressionOp.SubsetRank: {
                        ...
                        if (
                            (n < 0L) ||
                            (n > MaskBits) ||
                            ((n < MaskBits) && ((((ulong)mask) >> ((int)n)) != 0UL))
                        ) { return false; }
                        Span<int> elements = stackalloc int[MaskBits];
                        var count = 0;

                        for (var remaining = ((ulong)mask); (remaining != 0UL); remaining &= (remaining - 1UL)) {
                            elements[count++] = System.Numerics.BitOperations.TrailingZeroCount(value: remaining);
                        }
                        return TryLong(
                            count: Combinatorics.CombinationRank(
                                n: ((int)n),
                                combination: elements[..count]
                            ),
                            value: out value
                        );
                    }
                case ExpressionOp.SubsetAt: {
                        ...
                        Combinatorics.CombinationUnrank(
                            n: ((int)n),
                            rank: ((ulong)arguments[2]),
                            destination: elements[..((int)k)]
                        );
                        var mask = 0UL;
                ...
                case ExpressionOp.SubsetMember:
                    ...
                    value = Combinatorics.CombinationElement(
                        n: ((int)arguments[0]),
                        k: ((int)arguments[1]),
                        rank: ((ulong)arguments[2]),
                ...
                case ExpressionOp.ArrangementRank: {
                        ...
                        return TryLong(
                            count: Combinatorics.PermutationRank(permutation: elements[..((int)n)]),
                            value: out value
                        );
                    }
                ...
                case ExpressionOp.ArrangementMember: {
                        ...
                        Combinatorics.PermutationUnrank(
                            rank: ((ulong)arguments[1]),
                            destination: elements[..((int)n)]
                        );
    ...
    private static bool TrySquare(long value, out Puck.Maths.SquareIndex cell) {
        if (
            (value < 0L) ||
            (value > Puck.Maths.SquareIndex.MaxValue)
        ) {
            cell = default;
            return false;
        }
