...
public sealed class CarriageVerifyResult {
    ...
    internal static CarriageVerifyResult Accept(IReadOnlySet<string> reach, ReplayCommitRequirement? replayCommit) => new(
        verified: true,
        refusalReason: null,
        reach: reach,
        replayCommit: replayCommit
    ...
    internal static CarriageVerifyResult Refuse(string reason) => new(
        verified: false,
