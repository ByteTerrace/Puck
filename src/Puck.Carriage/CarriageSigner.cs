...
public static class CarriageSigner {
    ...
    /// <param name="signingAlgorithm">The REAL algorithm used for the cryptographic operation (must resolve to a <see cref="CarriageKeyRole.Signing"/> descriptor).</param>
