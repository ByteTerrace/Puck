...
/// vocabulary <c>Puck.Scripting.Simulation.AddonSourceCatalog.TryResolve</c> derives from
/// <c>Puck.Input.InputSources</c>' own declared attributes. Consulted by binding-vocabulary validation
/// (<c>Puck.World.WorldAffordances</c>); the addon wasm ABI's own channel-name vocabulary is a distinct, closed
/// set described by <see cref="AddonChannelValueShape"/>, resolved through <see cref="IAddonChannelResolver"/>
/// instead.</summary>
