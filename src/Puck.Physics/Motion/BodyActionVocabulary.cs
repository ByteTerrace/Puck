...
public enum BodyFacts : ushort {
    ...
    All = (Grounded | Airborne | Rising | Falling | Submerged | AtSurface | HoldingUnwalkable | Unsupported | Resting),
}
...
public static class BodyFactVocabulary {
    ...
    private static readonly (ActionFact Fact, BodyFacts Bit, string Token)[] s_rows = [
        ...
        (ActionFact.Submerged, BodyFacts.Submerged, "submerged"),
        (ActionFact.AtSurface, BodyFacts.AtSurface, "atsurface"),
