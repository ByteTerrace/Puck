...
public sealed partial class WorldRuleHost {
    ...
    internal bool TryArmRuleTrace(string rule, int evaluations, out string refusal) {
        if (
            (evaluations < 1) ||
