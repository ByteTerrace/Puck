...
`scanEveryTicks` sets connection scan cadence. `worker` optionally sets the
...
`world.extensions` reports the host console's operation names, connection wiring, and failures;
