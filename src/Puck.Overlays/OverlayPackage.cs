...
/// pipeline layout, from the pass-pipeline cache on the thread pool. Its recorder takes them when the graph installs and, since it never waits a fence of its
