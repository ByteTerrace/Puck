...
/// <summary>
/// Represents a render-chain node that can capture the next frame it produces. Overlay decorators implement this
/// interface so capture requests can target the outermost rendered result without widening <c>IRenderNode</c>.
/// </summary>
/// <remarks>
...
/// actually produced the frame that will be shown (down to the bare SDF producer at the bottom of the chain).
/// </remarks>
