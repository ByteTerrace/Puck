...
/// and the font-atlas bake pipeline's (<c>tools/font-atlas</c>) MTSDF atlas carries the true distance in alpha by
/// convention, so a consumer of either source samples alpha uniformly.
/// </remarks>
