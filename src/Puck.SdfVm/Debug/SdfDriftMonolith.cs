...
public static class SdfDriftMonolith {
    ...
    public static void Emit(SdfProgramBuilder builder) {
        ...
        var ground = builder.AddMaterial(material: new SdfMaterial(Albedo: new Vector3(
            x: 0.5f,
            y: 0.52f,
            z: 0.58f
        )));
        var brick = builder.AddMaterial(material: new SdfMaterial(Albedo: new Vector3(
            x: 0.8f,
            y: 0.35f,
            z: 0.25f
        )));
        var teal = builder.AddMaterial(material: new SdfMaterial(Albedo: new Vector3(
            x: 0.2f,
            y: 0.7f,
            z: 0.7f
        )));
        var rose = builder.AddMaterial(material: new SdfMaterial(Albedo: new Vector3(
            x: 0.9f,
            y: 0.35f,
            z: 0.45f
        )));
        // The two hex-stride rows are reached ONLY through the wallpaper chain's 3-coloring — never named directly.
        _ = builder.AddMaterial(material: new SdfMaterial(Albedo: new Vector3(
            x: 0.4f,
            y: 0.85f,
            z: 0.6f
        )));
        ...
        var jade = builder.AddMaterial(material: new SdfMaterial(Albedo: new Vector3(
            x: 0.2f,
            y: 0.7f,
            z: 0.45f
        )));
        var wall = builder.AddMaterial(material: new SdfMaterial(Albedo: new Vector3(
            x: 0.45f,
            y: 0.48f,
            z: 0.52f
        )));
        ...
        var seamCream = builder.AddMaterial(material: new SdfMaterial(
            Albedo: new Vector3(
                x: 0.96f,
                y: 0.9f,
                z: 0.72f
        ...
        var seamAzure = builder.AddMaterial(material: new SdfMaterial(
            Albedo: new Vector3(
                x: 0.25f,
                y: 0.5f,
                z: 0.96f
