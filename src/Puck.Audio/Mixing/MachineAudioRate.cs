...
/// <summary>The single-sourced machine-audio output rate — every booted <c>IMachineRuntime</c> synthesizes at this
...
/// <c>IMachineEngine.Create</c>) and <see cref="AudioMixer"/> (the presentation-side mixer that
