...
public enum QrErrorCorrectionLevel {
    ...
    Low = 0b01,
    /// <summary>~15% of codewords recoverable — the authored default for a QR screen source. Format-info
...
/// <summary>
/// The ONE spelling of the single-letter error-correction token — a QR screen source's <c>EcLevel</c> string, the
/// <c>screen.source &lt;index&gt; qr</c> verb's optional argument, and every refusal that names a level all read and write it
