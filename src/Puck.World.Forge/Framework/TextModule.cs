...
internal sealed class TextModule {
    ...
    /// <returns>The tile id.</returns>
    public byte TileFor(char character) => TileFor(character: character, fontTileBase: m_fontTileBase);
    ...
    public void EmitPrintQueued(RomTable text, int row, int column) =>
        EmitPrint(column: column, label: m_printQueuedLabel, row: row, text: text);
    ...
    public void EmitPrintDirect(RomTable text, int row, int column) =>
        EmitPrint(column: column, label: m_printDirectLabel, row: row, text: text);
    ...
    public void EmitPrintBcdQueued(ushort bcdAddress, int byteCount, int row, int column) =>
        EmitPrintBcd(bcdAddress: bcdAddress, byteCount: byteCount, column: column, label: m_printBcdQueuedLabel, row: row);
    ...
    public void EmitPrintBcdDirect(ushort bcdAddress, int byteCount, int row, int column) =>
        EmitPrintBcd(bcdAddress: bcdAddress, byteCount: byteCount, column: column, label: m_printBcdDirectLabel, row: row);
