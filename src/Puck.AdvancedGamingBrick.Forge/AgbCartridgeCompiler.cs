...
public sealed class AgbCartridgeCompiler : ICartridgeCompiler {
    ...
    public CartridgeCompilation Compile(CartridgeDocument document) {
        ...
        var layout = new CartridgeStateLayout(document: document);
        ...
        uint Waveform(int[]? levels) => ((levels is null)
            ? 0u
            : Add(bytes: Enumerable.Range(count: 16, start: 0).Select(selector: index => ((byte)((levels[(index * 2)] << 4) | levels[((index * 2) + 1)]))).ToArray()));
        ...
        if (document.Save is { } declared) {
            ...
            foreach (var name in declared.Variables) {
                ...
                defaults.AddRange(collection: layout.InitialBytes(name: name));
            }
        ...
        if ((document.Bitmap is { } surface) && (surface.Clear is { } fill)) {
            ...
            emitter.ShiftImmediate(amount: 8, destination: LowRegister.R1, op: ThumbShift.LogicalLeft, source: LowRegister.R1);
            emitter.Alu(destination: LowRegister.R0, op: ThumbAlu.Or, source: LowRegister.R1);
            emitter.MoveRegister(destination: LowRegister.R1, source: LowRegister.R0);
            emitter.ShiftImmediate(amount: 16, destination: LowRegister.R1, op: ThumbShift.LogicalLeft, source: LowRegister.R1);
            emitter.Alu(destination: LowRegister.R0, op: ThumbAlu.Or, source: LowRegister.R1);
            emitter.LoadConstant(destination: LowRegister.R2, value: BitmapFillAddress);
            emitter.StoreWord(baseRegister: LowRegister.R2, byteOffset: 0, source: LowRegister.R0);
        ...
        if (document.Window is { } placed) {
            ...
            emitter.SubtractRegister(destination: LowRegister.R0, operand: LowRegister.R0, source: LowRegister.R1);
            ...
            Load(expression: placed.X, register: LowRegister.R0);
            emitter.ShiftImmediate(amount: 8, destination: LowRegister.R0, op: ThumbShift.LogicalLeft, source: LowRegister.R0);
        ...
        for (var i = 0; (i < document.Sprites.Length); ++i) {
            ...
            if (sprite.Palette is { } slot) {
                EmitFlagBits(mask: 15, shift: 12, value: slot);
            }
            ...
            if (sprite.BehindBackground is { } behind) {
                EmitFlagBits(mask: 1, shift: 10, value: behind);
            }
            ...
            if (sprite.Turn is null) {
                if (sprite.FlipX is { } mirrorX) { EmitFlagBits(mask: 1, shift: 12, value: mirrorX); }
                if (sprite.FlipY is { } mirrorY) { EmitFlagBits(mask: 1, shift: 13, value: mirrorY); }
            }
        ...
        void EmitQueueDrain() {
            ...
            emitter.ShiftImmediate(amount: 5, destination: LowRegister.R0, op: ThumbShift.LogicalLeft, source: LowRegister.R0);
            emitter.LoadByte(baseRegister: LowRegister.R4, byteOffset: 1, destination: LowRegister.R1);
            emitter.AddRegister(destination: LowRegister.R0, operand: LowRegister.R1, source: LowRegister.R0);
            emitter.ShiftImmediate(amount: 1, destination: LowRegister.R0, op: ThumbShift.LogicalLeft, source: LowRegister.R0);
            emitter.LoadConstant(destination: LowRegister.R2, value: 0x0600F800u);
            emitter.AddRegister(destination: LowRegister.R0, operand: LowRegister.R2, source: LowRegister.R0);
            ...
            emitter.ShiftImmediate(amount: 12, destination: LowRegister.R2, op: ThumbShift.LogicalLeft, source: LowRegister.R2);
            emitter.Alu(destination: LowRegister.R1, op: ThumbAlu.Or, source: LowRegister.R2);
        ...
        void EmitQueuePush(CartridgeStatement statement) {
            ...
            emitter.LoadConstant(destination: LowRegister.R4, value: QueueBaseAddress);
            emitter.ShiftImmediate(amount: 2, destination: LowRegister.R0, op: ThumbShift.LogicalLeft, source: LowRegister.R1);
            emitter.AddRegister(destination: LowRegister.R4, operand: LowRegister.R0, source: LowRegister.R4);
            emitter.MoveImmediate(destination: LowRegister.R0, value: 31);
            emitter.Alu(destination: LowRegister.R5, op: ThumbAlu.And, source: LowRegister.R0);
            emitter.Alu(destination: LowRegister.R6, op: ThumbAlu.And, source: LowRegister.R0);
        ...
        void EmitBlit(CartridgeStatement statement, uint sourceAddress, int width, int height) {
            ...
            for (var line = 0; (line < height); ++line) {
                ...
                Copy(count: (width * 2), destination: destination, sourceAddress: (sourceAddress + ((uint)((line * width) * 2))));
            }
        }
        ...
        void Enable(uint bit) {
            ...
            emitter.Alu(destination: LowRegister.R4, op: ThumbAlu.Or, source: LowRegister.R0);
        }
        ...
        void Gate(ActionPredicate? predicate, int fail) {
            switch (predicate) {
                ...
                case ActionPredicate.All all:
                    foreach (var inner in all.Predicates) { Gate(fail: fail, predicate: inner); }
                ...
                case ActionPredicate.Any any: {
                        ...
                        foreach (var inner in any.Predicates) {
                            ...
                            Gate(fail: next, predicate: inner);
                ...
                default: {
                        ...
                        emitter.Pop(includeProgramCounter: false, registers: LowRegisterMask.R0);
                ...
                switch (statement.Kind) {
                    ...
                    case "if": {
                            ...
                            if (statement.Else is { } alternative) {
                                ...
                                Statements(breakLabel: breakLabel, statements: alternative);
                    ...
                    case "save": {
                            ...
                            foreach (var (address, length) in persisted) {
                                CopyBytes(count: length, destination: (SaveMirrorAddress + ((uint)offset)), sourceAddress: address);
                                offset += length;
                            }
                    ...
                    case "load": {
                            ...
                            foreach (var (address, length) in persisted) {
                                CopyBytes(count: length, destination: address, sourceAddress: (SaveMirrorAddress + ((uint)offset)));
                                offset += length;
                            }
                    ...
                    case "blend": {
                            ...
                            emitter.MoveImmediate(destination: LowRegister.R1, value: CartridgeLimits.BlendWeights);
                            emitter.SubtractRegister(destination: LowRegister.R1, operand: LowRegister.R0, source: LowRegister.R1);
                            emitter.ShiftImmediate(amount: 8, destination: LowRegister.R1, op: ThumbShift.LogicalLeft, source: LowRegister.R1);
                            emitter.Alu(destination: LowRegister.R0, op: ThumbAlu.Or, source: LowRegister.R1);
                    ...
                    case "plot": {
                            ...
                            emitter.Alu(destination: LowRegister.R5, op: ThumbAlu.Compare, source: LowRegister.R0);
                            ...
                            emitter.Alu(destination: LowRegister.R6, op: ThumbAlu.Compare, source: LowRegister.R0);
                            emitter.Branch(condition: ThumbCondition.UnsignedHigher, label: dropped);
                            emitter.Branch(condition: ThumbCondition.Equal, label: dropped);

                            // r5 becomes the pixel's byte offset: row times the width, plus the column.
                            emitter.LoadConstant(destination: LowRegister.R0, value: CartridgeBitmap.Width);
                            emitter.Alu(destination: LowRegister.R6, op: ThumbAlu.Multiply, source: LowRegister.R0);
                            emitter.AddRegister(destination: LowRegister.R5, operand: LowRegister.R6, source: LowRegister.R5);
                            ...
                            emitter.AddRegister(destination: LowRegister.R0, operand: LowRegister.R5, source: LowRegister.R0);

                            // Video memory ignores a single-byte write, so the pixel's halfword is read and rebuilt.
                            emitter.MoveImmediate(destination: LowRegister.R1, value: 1);
                            emitter.Alu(destination: LowRegister.R5, op: ThumbAlu.And, source: LowRegister.R1);
                            emitter.MoveImmediate(destination: LowRegister.R1, value: 1);
                            emitter.Alu(destination: LowRegister.R0, op: ThumbAlu.BitClear, source: LowRegister.R1);
                            emitter.LoadHalf(baseRegister: LowRegister.R0, byteOffset: 0, destination: LowRegister.R6);
                            ...
                            emitter.Alu(destination: LowRegister.R6, op: ThumbAlu.And, source: LowRegister.R1);
                            emitter.Alu(destination: LowRegister.R6, op: ThumbAlu.Or, source: LowRegister.R7);
                            emitter.Branch(label: written);
                            emitter.MarkLabel(label: odd);
                            emitter.MoveImmediate(destination: LowRegister.R1, value: 0xFF);
                            emitter.Alu(destination: LowRegister.R6, op: ThumbAlu.And, source: LowRegister.R1);
                            emitter.ShiftImmediate(amount: 8, destination: LowRegister.R7, op: ThumbShift.LogicalLeft, source: LowRegister.R7);
                            emitter.Alu(destination: LowRegister.R6, op: ThumbAlu.Or, source: LowRegister.R7);
                            emitter.MarkLabel(label: written);
                            emitter.StoreHalf(baseRegister: LowRegister.R0, byteOffset: 0, source: LowRegister.R6);
                    ...
                    case "blit": {
                            ...
                            EmitBlit(height: screen.Height, sourceAddress: screen.Address, statement: statement, width: screen.Width);
                            break;
                        }
                    default:
        ...
        void Act(CartridgeStatement action) {
            ...
            emitter.Push(includeLinkRegister: false, registers: LowRegisterMask.R4);
            if (action.Operation is null) {
                Load(expression: action.Value!, register: LowRegister.R0);
                emitter.Pop(includeProgramCounter: false, registers: LowRegisterMask.R4);
            ...
            if (Wide(target: action.Target!)) {
                emitter.LoadHalf(baseRegister: LowRegister.R4, byteOffset: 0, destination: LowRegister.R0);
            } else {
                emitter.LoadByte(baseRegister: LowRegister.R4, byteOffset: 0, destination: LowRegister.R0);
            }

            switch (action.Operation) {
                case ExpressionOp.Add: emitter.AddRegister(destination: LowRegister.R0, operand: LowRegister.R1, source: LowRegister.R0); break;
                case ExpressionOp.Subtract: emitter.SubtractRegister(destination: LowRegister.R0, operand: LowRegister.R1, source: LowRegister.R0); break;
                case ExpressionOp.Multiply: arithmetic.EmitMultiply(); break;
                case ExpressionOp.Divide: arithmetic.EmitDivide(); break;
                case ExpressionOp.Remainder: arithmetic.EmitDivide(); emitter.MoveRegister(destination: LowRegister.R0, source: LowRegister.R5); break;
        ...
        void Store(CartridgeTarget target, LowRegister source) {
            if (Wide(target: target)) {
                emitter.StoreHalf(baseRegister: LowRegister.R4, byteOffset: 0, source: source);
        ...
        void Load(ExpressionProgram expression, LowRegister register, bool guard = false) {
            ...
            emitter.Push(includeLinkRegister: false, registers: LowRegisterMask.R4 | LowRegisterMask.R5);
            ...
            foreach (var token in expression.Instructions) {
                if (token.Payload is InstructionPayload.Constant or InstructionPayload.State) {
                    ...
                    Payload(guard: guard, register: LowRegister.R0, token: token);
                    ++depth;
            ...
            emitter.Pop(includeProgramCounter: false, registers: LowRegisterMask.R4 | LowRegisterMask.R5);
        ...
        void Payload(Instruction token, LowRegister register, bool guard) {
            ...
            if (widths[state.Name.Spelling] == 2) {
                emitter.LoadHalf(baseRegister: LowRegister.R2, byteOffset: 0, destination: register);
            } else {
                emitter.LoadByte(baseRegister: LowRegister.R2, byteOffset: 0, destination: register);
            }
        }
        ...
        void Button(string button, string mode, LowRegister register) {
            ...
            if (mode == "released") {
                ...
                emitter.Alu(destination: LowRegister.R1, op: ThumbAlu.BitClear, source: LowRegister.R0);
            ...
            emitter.Alu(destination: LowRegister.R0, op: ThumbAlu.And, source: LowRegister.R1);
            emitter.CompareImmediate(register: LowRegister.R0, value: 0);
        ...
        void Unary(ExpressionOp operation) {
            switch (operation) {
                case ExpressionOp.BitNot:
                    emitter.Alu(destination: LowRegister.R0, op: ThumbAlu.MoveNegated, source: LowRegister.R0);
                    Truncate();

                    return;
                case ExpressionOp.Negate:
                    emitter.Alu(destination: LowRegister.R0, op: ThumbAlu.Negate, source: LowRegister.R0);
                    Truncate();
        ...
        void Binary(ExpressionOp operation) {
            ...
            emitter.Pop(includeProgramCounter: false, registers: LowRegisterMask.R0);
            switch (operation) {
                case ExpressionOp.Add: emitter.AddRegister(destination: LowRegister.R0, operand: LowRegister.R1, source: LowRegister.R0); Truncate(); return;
                case ExpressionOp.Subtract: emitter.SubtractRegister(destination: LowRegister.R0, operand: LowRegister.R1, source: LowRegister.R0); Truncate(); return;
                case ExpressionOp.Multiply: arithmetic.EmitMultiply(); Truncate(); return;
                case ExpressionOp.Divide: arithmetic.EmitDivide(); return;
                case ExpressionOp.Remainder: arithmetic.EmitDivide(); emitter.MoveRegister(destination: LowRegister.R0, source: LowRegister.R5); return;
                ...
                case ExpressionOp.BitAnd: emitter.Alu(destination: LowRegister.R0, op: ThumbAlu.And, source: LowRegister.R1); return;
                case ExpressionOp.BitOr: emitter.Alu(destination: LowRegister.R0, op: ThumbAlu.Or, source: LowRegister.R1); return;
                case ExpressionOp.BitXor: emitter.Alu(destination: LowRegister.R0, op: ThumbAlu.ExclusiveOr, source: LowRegister.R1); return;
        ...
        void Ternary(ExpressionOp operation) {
            ...
            emitter.Alu(destination: LowRegister.R0, op: ThumbAlu.Compare, source: LowRegister.R3);
        ...
        void Element(string array, ExpressionProgram index, LowRegister address, bool guard = false) {
            ...
            Load(expression: index, guard: guard, register: LowRegister.R3);
            ...
            emitter.AddRegister(destination: address, operand: LowRegister.R3, source: address);
            emitter.MarkLabel(label: done);
        }
        ...
        void EmitFlagBits(ExpressionProgram value, byte mask, int shift) {
            ...
            emitter.ShiftImmediate(amount: shift, destination: LowRegister.R0, op: ThumbShift.LogicalLeft, source: LowRegister.R0);
            emitter.Pop(includeProgramCounter: false, registers: LowRegisterMask.R5);
            emitter.Alu(destination: LowRegister.R0, op: ThumbAlu.Or, source: LowRegister.R5);
        }
