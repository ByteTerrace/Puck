...
public sealed class AgbForgeKernel {
    ...
    private void EmitFillRectRoutine() {
        ...
        m_emitter.Push(
            ...
            registers: LowRegisterMask.R5 | LowRegisterMask.R6 | LowRegisterMask.R7
        );
        m_emitter.LoadConstant(
            destination: LowRegister.R5,
            value: AgbHw.VideoRam
        );
        m_emitter.MoveImmediate(
            destination: LowRegister.R6,
            value: ((byte)AgbHw.ScreenWidth)
        );
        m_emitter.Alu(
    ...
    private void EmitFrameSyncRoutine() {
        ...
        m_emitter.LoadHalf(
            ...
            byteOffset: AgbHw.VerticalCounterOffset,
            destination: LowRegister.R1
        );
        m_emitter.CompareImmediate(
            register: LowRegister.R1,
            value: ((byte)AgbHw.ScreenHeight)
        );
        m_emitter.Branch(
            condition: ThumbCondition.CarrySet,
            label: waitOut
        );
        ...
        m_emitter.Branch(
            condition: ThumbCondition.CarryClear,
            label: waitIn
        );

        m_emitter.LoadConstant(
            destination: LowRegister.R0,
            value: AgbHw.KeyInput
        );
        m_emitter.LoadHalf(
            baseRegister: LowRegister.R0,
            byteOffset: 0,
        ...
        m_emitter.LoadConstant(
            destination: LowRegister.R0,
            value: AgbForgeMemoryMap.StateBase
        );
        m_emitter.LoadHalf(
            baseRegister: LowRegister.R0,
            byteOffset: AgbForgeMemoryMap.InputHeldOffset,
            destination: LowRegister.R2
        );
        m_emitter.StoreHalf(
            baseRegister: LowRegister.R0,
            byteOffset: AgbForgeMemoryMap.InputPreviousOffset,
            source: LowRegister.R2
        );
        m_emitter.StoreHalf(
            baseRegister: LowRegister.R0,
        ...
        m_emitter.StoreHalf(
            baseRegister: LowRegister.R0,
            byteOffset: AgbForgeMemoryMap.InputPressedOffset,
            source: LowRegister.R2
        );
    ...
    private void EmitPrngNextRoutine() {
        ...
        m_emitter.LoadHalf(
            ...
            byteOffset: AgbForgeMemoryMap.PrngStateOffset,
            destination: LowRegister.R0
        );
        m_emitter.ShiftImmediate(
            amount: 2,
    ...
    public void EmitBootPrologue() {
        ...
        m_emitter.MoveImmediate(
            destination: LowRegister.R1,
            value: (AgbForgeMemoryMap.FrameworkByteCount / 4)
        );
        m_emitter.MoveImmediate(
            destination: LowRegister.R2,
            value: 0
        ...
        m_emitter.LoadConstant(
            destination: LowRegister.R0,
            value: AgbHw.DisplayControl
        );
        m_emitter.LoadConstant(
            destination: LowRegister.R1,
            value: AgbHw.Mode3WithBg2
        );
        m_emitter.StoreHalf(
            baseRegister: LowRegister.R0,
            byteOffset: 0,
