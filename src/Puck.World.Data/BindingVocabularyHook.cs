...
/// (<c>Puck.Input</c>) — <c>Puck.World.Data</c> must not reference <c>Puck.Input</c> at all (the architecture gate's
...
/// Puck.World.exe; <c>tests/Puck.World.Tests</c> is the sole other caller that loads Puck.World.Data without
