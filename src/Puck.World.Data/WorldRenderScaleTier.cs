...
/// PROGRAMMATICALLY (layout eases, dev tooling) — the enumerated policy lives only here at
/// the user surface. Names + scales are the ONE definition (<see cref="WorldRenderScaleTiers"/>); the world document's
/// quality presets, the console <c>world.render-scale</c> verb, and the boot resolution all read them there.
/// </summary>
