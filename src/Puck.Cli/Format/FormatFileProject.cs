    ...
    internal static int Run(string file, HashSet<string> selected, bool whatIf, bool verify) {
        ...
        try {
            ...
            if (directives.Length > 0) {
                ...
                File.WriteAllText(
                    contents: "<Project Sdk=\"Microsoft.NET.Sdk\"><PropertyGroup><TargetFramework>net10.0</TargetFramework><OutputType>Library</OutputType></PropertyGroup></Project>",
                    path: project
                );
            }
