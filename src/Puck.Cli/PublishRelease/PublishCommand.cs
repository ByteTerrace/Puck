...
internal static class PublishCommand {
    ...
    public static Command Create() {
        ...
        var command = new Command(
            ...
            """,
            name: "publish"
        ) { appOption, channelOption, inputOption, minimumSupportedOption, notesOption, outOption, ridOption, rolloutPercentOption, stateGenerationOption, versionOption };
        ...
        command.SetAction(action: parseResult => Run(
            ...
            outputRoot: parseResult.GetRequiredValue(option: outOption),
