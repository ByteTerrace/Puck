...
internal static class LengthsCommand {
    ...
    public static int Run(string[] args) {
        ...
        if (!TryReadLedger(ceiling: out var ceiling, error: out var error, path: ledgerPath, recorded: out var recorded)) {
        ...
        var refusals = problems.Where(predicate: static problem => (problem.StartsWith(comparisonType: StringComparison.Ordinal, value: "grew:") || problem.StartsWith(comparisonType: StringComparison.Ordinal, value: "new:"))).ToList();
        ...
        WriteLedger(ceiling: ceiling, path: ledgerPath, recorded: next);
    ...
    private static bool IsAutoGenerated(byte[] bytes) {
        ...
        return (head.Contains(comparisonType: StringComparison.OrdinalIgnoreCase, value: "<auto-generated") || head.Contains(comparisonType: StringComparison.OrdinalIgnoreCase, value: "<autogenerated"));
    }
