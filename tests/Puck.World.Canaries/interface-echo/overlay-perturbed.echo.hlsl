// The echo pass of shader interface 'overlay-perturbed' (sha256/160de6fee5481246cadfe66ce824c143d49d08a3d6b02eb9c0845f157c75948b), generated from the interface and perturbed by hand: its last member's first word expects the sentinel of the word after it.
...
void main(uint3 id : SV_DispatchThreadID) {
    ...
    echo[uint2(15, 0)] = ((asuint(passGroup.sdf.x) == 0x4000E3A5u) && (asuint(passGroup.sdf.y) == 0x4000E3A5u) && (asuint(passGroup.sdf.z) == 0x4000F3A5u) && (asuint(passGroup.sdf.w) == 0x400103A5u)) ? float4(0.0, 1.0, 0.0, 1.0) : float4(1.0, 0.0, 0.0, 1.0);
}
