// The echo pass of shader interface 'ink-visualize' (sha256/5e5bcc872b5542691f3024adf42873ef4b3378cb1962f5a26d1dc8d9d6dd4e52), generated from the interface; never edit it.
...
void main(uint3 id : SV_DispatchThreadID) {
    ...
    echo[uint2(13, 0)] = ((asuint(passGroup.exposure) == 0x400033A5u)) ? float4(0.0, 1.0, 0.0, 1.0) : float4(1.0, 0.0, 0.0, 1.0);
}
