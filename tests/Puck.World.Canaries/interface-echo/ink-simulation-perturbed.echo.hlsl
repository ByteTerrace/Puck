// The echo pass of shader interface 'ink-simulation-perturbed' (sha256/341665bcfe4d1cbd9fa01aaf0b76b68e6164ab278e3c74add20198efa523f6c2), generated from the interface and perturbed by hand: its last member's first word expects the sentinel of the word after it.
...
void main(uint3 id : SV_DispatchThreadID) {
    ...
    echo[uint2(13, 0)] = ((asuint(passGroup.decay) == 0x400043A5u)) ? float4(0.0, 1.0, 0.0, 1.0) : float4(1.0, 0.0, 0.0, 1.0);
}
