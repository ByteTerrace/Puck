// The echo pass of shader interface 'tint-perturbed' (sha256/a798ae843ae959e16e16a71baf7cd3cbcc49c17c7b04d6651bf17a65411ecc66), generated from the interface and perturbed by hand: its last member's first word expects the sentinel of the word after it.
...
void main(uint3 id : SV_DispatchThreadID) {
    ...
    echo[uint2(13, 0)] = ((asuint(passGroup.gain) == 0x400043A5u)) ? float4(0.0, 1.0, 0.0, 1.0) : float4(1.0, 0.0, 0.0, 1.0);
}
