// The echo pass of shader interface 'ink-simulation' (sha256/3c597cf5952c20b2f1c53cb6bf7fd50f02e06621b691b74e3bdd5e71aedb6fce), generated from the interface; never edit it.
...
void main(uint3 id : SV_DispatchThreadID) {
    ...
    echo[uint2(13, 0)] = ((asuint(passGroup.decay) == 0x400033A5u)) ? float4(0.0, 1.0, 0.0, 1.0) : float4(1.0, 0.0, 0.0, 1.0);
}
