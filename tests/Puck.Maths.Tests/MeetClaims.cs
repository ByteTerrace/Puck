...
internal static class MeetClaims {
    ...
    private static MeetProduct<MeetMask64, MeetQuantity64> Envelope(long maskLane, long amountLane) =>
        new(
            First: Mask(lane: maskLane),
            Second: Quantity(lane: amountLane)
        );
    ...
    public static string? BottomAbsorbs(long[] left, long[] right) {
        ...
        foreach (var raw in raws) {
            ...
            if (
                (MeetMask64.Meet(
                left: mask,
                right: MeetMask64.Bottom
            ) != MeetMask64.Bottom) ||
                (MeetMask64.Meet(
                left: MeetMask64.Bottom,
                right: mask
            ) != MeetMask64.Bottom)
            ) {
            ...
            if (
                (MeetQuantity64.Meet(
                left: quantity,
                right: MeetQuantity64.Bottom
            ) != MeetQuantity64.Bottom) ||
                (MeetQuantity64.Meet(
                left: MeetQuantity64.Bottom,
                right: quantity
            ) != MeetQuantity64.Bottom)
            ) {
        ...
        if (
            (MeetProduct<MeetMask64, MeetQuantity64>.Meet(
            left: envelope,
            right: bottom
        ) != bottom) ||
            (MeetProduct<MeetMask64, MeetQuantity64>.Meet(
    ...
    public static string? MeetIsAssociative(long[] left, long[] right) {
        ...
        foreach (var (a, b, c) in triples) {
            ...
            if (MeetQuantity64.Meet(
                left: MeetQuantity64.Meet(
                    left: quantityA,
                    right: quantityB
                ),
                right: quantityC
        ...
        var envelopeC = Envelope(
            maskLane: left[2],
            amountLane: right[2]
        );
        var leftFold = MeetProduct<MeetMask64, MeetQuantity64>.Meet(
            left: MeetProduct<MeetMask64, MeetQuantity64>.Meet(
                left: envelopeA,
                right: envelopeB
            ),
            right: envelopeC
        );
        var rightFold = MeetProduct<MeetMask64, MeetQuantity64>.Meet(
            left: envelopeA,
            right: MeetProduct<MeetMask64, MeetQuantity64>.Meet(
                left: envelopeB,
                right: envelopeC
            )
        );
    ...
    public static string? MeetIsCommutative(long[] left, long[] right) {
        ...
        return ((MeetProduct<MeetMask64, MeetQuantity64>.Meet(
            left: envelopeA,
            right: envelopeB
        ) == MeetProduct<MeetMask64, MeetQuantity64>.Meet(
            left: envelopeB,
    ...
    public static string? MeetNeverWidens(long[] left, long[] right) {
        ...
        var quantityMeet = MeetQuantity64.Meet(
            left: quantityA,
            right: quantityB
        );

        if (
            (quantityMeet.Amount > quantityA.Amount) ||
            (quantityMeet.Amount > quantityB.Amount)
        ) {
        ...
        if (
            (quantityLower.Amount <= quantityA.Amount) &&
            (quantityLower.Amount <= quantityB.Amount) &&
            (quantityLower.Amount > quantityMeet.Amount)
        ) {
        ...
        var envelopeMeet = MeetProduct<MeetMask64, MeetQuantity64>.Meet(
            left: envelopeA,
            right: envelopeB
        );

        return ((BitwiseSubset(
            narrow: envelopeMeet.First.Bits,
            wide: envelopeA.First.Bits
        ) &&
                BitwiseSubset(
            narrow: envelopeMeet.First.Bits,
            wide: envelopeB.First.Bits
        ) &&
    ...
    public static string? OrderAgreesWithMeet(long[] left, long[] right) {
        ...
        foreach (var (a, b) in maskPairs) {
            if (a.IsAtMost(other: b) != (MeetMask64.Meet(
                left: a,
                right: b
            ) == a)) {
        ...
        foreach (var (a, b) in quantityPairs) {
            if (a.IsAtMost(other: b) != (MeetQuantity64.Meet(
                left: a,
                right: b
            ) == a)) {
        ...
        foreach (var (a, b) in envelopePairs) {
            if (a.IsAtMost(other: b) != (MeetProduct<MeetMask64, MeetQuantity64>.Meet(
                left: a,
                right: b
            ) == a)) {
    ...
    public static string? ProductComposesComponentwise(long[] left, long[] right) {
        ...
        var meet = MeetProduct<MeetMask64, MeetQuantity64>.Meet(
            left: envelopeA,
            right: envelopeB
        );

        if (
            (meet.First != MeetMask64.Meet(
            left: envelopeA.First,
            right: envelopeB.First
        )) ||
            (meet.Second != MeetQuantity64.Meet(
            left: envelopeA.Second,
            right: envelopeB.Second
        ))
        ) {
        ...
        if (
            (top.First != MeetMask64.Top) ||
            (top.Second != MeetQuantity64.Top) ||
            (bottom.First != MeetMask64.Bottom) ||
            (bottom.Second != MeetQuantity64.Bottom)
        ) {
        ...
        var nestedA = new MeetProduct<MeetProduct<MeetMask64, MeetQuantity64>, MeetMask64>(
            First: envelopeA,
            Second: Mask(lane: left[2])
        );
        var nestedB = new MeetProduct<MeetProduct<MeetMask64, MeetQuantity64>, MeetMask64>(
            First: envelopeB,
            Second: Mask(lane: right[2])
        );
        var nestedMeet = MeetProduct<MeetProduct<MeetMask64, MeetQuantity64>, MeetMask64>.Meet(
            left: nestedA,
            right: nestedB
        );

        return (((nestedMeet.First == meet) && (nestedMeet.Second == MeetMask64.Meet(
            left: nestedA.Second,
            right: nestedB.Second
        )))
            ? null
    ...
    public static string? TopIsIdentity(long[] left, long[] right) {
        ...
        foreach (var raw in raws) {
            ...
            if (
                (MeetQuantity64.Meet(
                left: quantity,
                right: MeetQuantity64.Top
            ) != quantity) ||
                (MeetQuantity64.Meet(
                left: MeetQuantity64.Top,
                right: quantity
            ) != quantity)
            ) {
        ...
        return (((MeetProduct<MeetMask64, MeetQuantity64>.Meet(
            left: envelope,
            right: top
        ) == envelope) && (MeetProduct<MeetMask64, MeetQuantity64>.Meet(
            left: top,
            right: envelope
        ) == envelope))
            ? null
