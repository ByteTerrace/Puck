...
internal static class WhtClaims {
    ...
    public static string? LengthRefusals() {
        return (Refuses(
            action: () => WalshHadamardTransform.Forward<long>(values: new long[0]),
            type: typeof(ArgumentException),
            parameterName: "values",
            what: "Forward on an empty span"
        ) ??
               (Refuses(
            action: () => WalshHadamardTransform.Forward<long>(values: new long[3]),
            type: typeof(ArgumentException),
            parameterName: "values",
            what: "Forward at length 3 (not a power of two)"
        ) ??
               (Refuses(
            action: () => WalshHadamardTransform.Forward<int>(values: new int[6]),
            type: typeof(ArgumentException),
            parameterName: "values",
            what: "Forward at length 6 (not a power of two)"
        ) ??
               (Refuses(
            action: () => WalshHadamardTransform.Inverse<long>(values: new long[0]),
            type: typeof(ArgumentException),
            parameterName: "values",
            what: "Inverse on an empty span"
        ) ??
               Refuses(
            action: () => WalshHadamardTransform.Inverse<long>(values: new long[5]),
            type: typeof(ArgumentException),
            parameterName: "values",
            what: "Inverse at length 5 (not a power of two)"
        )))));
    }
