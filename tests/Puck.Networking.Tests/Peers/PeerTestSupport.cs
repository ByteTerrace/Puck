...
internal static class PeerTestSupport {
    ...
    private static QuicPeerTransport NewTransport(PeerIdentity certificateOwner) {
        ...
        return new QuicPeerTransport(certificate: certificateOwner.CreateTransportCertificate());
    }
