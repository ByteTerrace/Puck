...
internal static class GpuGroupLayoutTables {
    /// <summary>Film grain: the frame block at set 0, and the pass block, a sampled image and a sampler at set 3.</summary>
    ...
    /// <summary>Pixelate: the frame block at set 0, and the pass block and two storage images at set 3.</summary>
    ...
    /// sampler array and a read-write buffer, and an instance group of samplers alone.</summary>
    ...
    internal static IReadOnlyList<(string Name, Func<GpuPipelineLayoutDescription> Build, string Refusal)> Refused { get; } = [
        ...
        ("one group declared twice", static () => new GpuPipelineLayoutDescription(groups: [Group(ordinal: 3), Group(ordinal: 3)], pushesIndex: false), "Group 3 is declared twice"),
    ];
