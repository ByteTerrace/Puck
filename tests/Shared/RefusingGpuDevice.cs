...
internal sealed class RefusingGpuDevice :
    ...
    IGpuStorageBuffer IGpuBufferFactory.CreateHostVisibleDeviceLocal(ulong sizeBytes, GpuBufferUsage usage) => throw Reach(member: "IGpuBufferFactory.CreateHostVisibleDeviceLocal");
