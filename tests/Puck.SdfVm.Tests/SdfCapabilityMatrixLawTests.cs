    ...
    private static readonly Row[] Matrix = [
        ...
        new(
            ...
            Members: [
                ...
                "SdfWorldEngine.MaxScreenSurfaces", "SdfWorldRenderSpec.ScreenSources", "SdfWorldRenderSpec.ScreenSourceFrames",
                "SdfWorldRenderSpec.ScreenLights",
            ]
        ),
        new(
            Capability: "decals",
