...
public sealed class SecondOrderFollowerTests {
    ...
    public void StepPoseHemisphereMatchesASignNegatedTargetAgainstItsPreviousTarget() {
        ...
        var start = Quaternion.CreateFromAxisAngle(
            axis: Vector3.UnitY,
            angle: 0f
        );
        var wanted = Quaternion.CreateFromAxisAngle(
            axis: Vector3.UnitY,
            angle: 0.2f
        );
        var negatedWanted = new Quaternion(
            w: -wanted.W,
            x: -wanted.X,
            y: -wanted.Y,
            z: -wanted.Z
        ...
        flippedOrientation.Seed(target: new Vector4(
            w: start.W,
            x: start.X,
            y: start.Y,
            z: start.Z
        ...
        referenceOrientation.Seed(target: new Vector4(
            w: start.W,
            x: start.X,
            y: start.Y,
            z: start.Z
