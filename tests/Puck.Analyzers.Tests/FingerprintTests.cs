...
public sealed class FingerprintTests {
    ...
    public void AlgorithmStillProducesTheHashTheCommittedLedgerRecords() {
        ...
        Assert.Equal(
            actual: hash,
            expected: Sources.BitMixRecordedHash
        );
    }
    [Fact]
    ...
    public void ChangingADependencysTypeChangesTheHash() {
        ...
        Assert.NotEqual(
            expected: DependentHashOf(
                source: Constant(type: "int"),
                dependencies: ["F:Subject.Assembly.Subject.Scale"]
            ),
            actual: DependentHashOf(
                source: Constant(type: "long"),
                dependencies: ["F:Subject.Assembly.Subject.Scale"]
            )
        );
    }
    ...
    public void ChangingTheRepresentationARecordStructsOperatorRestsOnChangesTheHash() {
        ...
        Assert.NotEqual(
            expected: DependentHashOf(
                source: Representation(carrier: "int"),
                dependencies: ["P:Subject.Assembly.Subject.Value"]
            ),
            actual: DependentHashOf(
                source: Representation(carrier: "long"),
                dependencies: ["P:Subject.Assembly.Subject.Value"]
            )
        );
    }
    ...
    public void CommentsAndWhitespaceDoNotChangeTheHash() {
        ...
        Assert.Equal(
            expected: HashOf(source: Sources.BrandedMethod()),
            actual: HashOf(source: commented)
        );
    }
    [Fact]
    ...
    public void DroppingADependencyFromTheLedgerChangesTheHash() {
        var narrowed = Sources.BitMixDependencies.Where(predicate: dependency => !dependency.EndsWith(
    ...
    public void EditingAConstantSharingOneFieldDeclarationWithADependencyDoesNotChangeTheHash() {
        ...
        Assert.Equal(
            expected: DependentHashOf(
                source: Shared(sibling: "1"),
                dependencies: ["F:Subject.Assembly.Subject.Scale"]
            ),
            actual: DependentHashOf(
                source: Shared(sibling: "2"),
                dependencies: ["F:Subject.Assembly.Subject.Scale"]
            )
        );
    }
    ...
    public void EditingASiblingMemberDoesNotChangeTheHash() {
        ...
        Assert.Equal(
            expected: HashOf(source: Sources.BrandedMethod()),
            actual: HashOf(source: withSibling)
        );
    }
    [Fact]
    ...
    public void EditingAnUnrelatedAttributeThatSharesTheBrandsNameChangesTheHash() {
        ...
        Assert.NotEqual(
            expected: HashOf(source: WithForeignAttribute(payload: "payload-a")),
            actual: HashOf(source: WithForeignAttribute(payload: "payload-b"))
        );
    }
    [Fact]
    ...
    public void EditingTheBrandedBodyChangesTheHash() =>
        Assert.NotEqual(
            expected: HashOf(source: Sources.BrandedMethod()),
            actual: HashOf(source: Sources.BrandedMethod(body: "        return 2;"))
        );
    [Fact]
    public void EditingTheBrandsOwnBasisDoesNotChangeAClassesHash() {
        ...
        Assert.Equal(
            expected: HashOf(source: Class(basis: "exhaustive")),
            actual: HashOf(source: Class(basis: "exact-by-proof"))
        );
    }
    [Fact]
    public void EditingTheBrandsOwnBasisDoesNotChangeAConstructorsHash() {
        ...
        Assert.Equal(
            expected: HashOf(source: Constructor(basis: "exhaustive")),
            actual: HashOf(source: Constructor(basis: "exact-by-proof"))
        );
    }
    [Fact]
    public void EditingTheBrandsOwnBasisDoesNotChangeAConversionOperatorsHash() {
        ...
        Assert.Equal(
            expected: HashOf(source: Conversion(basis: "exhaustive")),
            actual: HashOf(source: Conversion(basis: "exact-by-proof"))
        );
    }
    [Fact]
    public void EditingTheBrandsOwnBasisDoesNotChangeADestructorsHash() {
        ...
        Assert.Equal(
            expected: HashOf(source: Destructor(basis: "exhaustive")),
            actual: HashOf(source: Destructor(basis: "exact-by-proof"))
        );
    }
    [Fact]
    ...
    public void EditingTheBrandsOwnBasisDoesNotChangeARecordsHash() {
        ...
        Assert.Equal(
            expected: HashOf(source: Record(basis: "exhaustive")),
            actual: HashOf(source: Record(basis: "exact-by-proof"))
        );
    }
    [Fact]
    ...
    public void EditingTheBrandsOwnBasisDoesNotChangeAStructsHash() {
        ...
        Assert.Equal(
            expected: HashOf(source: Struct(basis: "exhaustive")),
            actual: HashOf(source: Struct(basis: "exact-by-proof"))
        );
    }
    [Fact]
    public void EditingTheBrandsOwnBasisDoesNotChangeAnAccessorsHash() =>
        Assert.Equal(
            expected: HashOf(source: BrandedGetter(basis: "exhaustive")),
            actual: HashOf(source: BrandedGetter(basis: "exact-by-proof"))
        );
    [Fact]
    public void EditingTheBrandsOwnBasisDoesNotChangeAnOperatorsHash() {
        ...
        Assert.Equal(
            expected: HashOf(source: Operator(basis: "exhaustive")),
            actual: HashOf(source: Operator(basis: "exact-by-proof"))
        );
    }
    [Fact]
    public void EditingTheBrandsOwnBasisDoesNotChangeTheHashWhenTheBrandIsAliased() =>
        Assert.Equal(
            expected: HashOf(source: Aliased(basis: "exhaustive")),
            actual: HashOf(source: Aliased(basis: "exact-by-proof"))
        );
    [Fact]
    ...
    public void RenamingAParameterChangesTheHash() {
        ...
        Assert.NotEqual(
            expected: HashOf(source: before),
            actual: HashOf(source: after)
        );
    }
    [Fact]
