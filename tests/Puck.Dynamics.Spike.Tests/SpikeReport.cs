...
/// <summary>
/// The measurement sink. Every number the spike reports is written here as it is produced, and the file lands beside
...
internal static class SpikeReport {
    ...
    internal static string Path => System.IO.Path.Combine(path1: AppContext.BaseDirectory, path2: "spike-measurements.txt");
