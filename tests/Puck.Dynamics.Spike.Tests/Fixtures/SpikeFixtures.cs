...
/// <summary>The six deliberately non-planar scenarios the spike proves its mechanics on.</summary>
internal static class SpikeFixtures {
    ...
    internal static SpikeWorld Corner(SolverOptions options) {
    ...
    internal static SolverOptions CornerOptions(int rateHz, int substepCount, int solveIterations = 1, bool warmStart = true, bool compositeIdentity = true) =>
        new() {
            RateHz = rateHz,
    ...
    /// <returns>The world.</returns>
    internal static SpikeWorld CapsuleWaist(SolverOptions options, CapsuleWitnessMode mode, out FieldSurface surface) {
        ArgumentNullException.ThrowIfNull(argument: options);
        ...
        return new(
            ...
            shape: SpikeShape.Capsule(segmentHalf: half, radius: radius),
    ...
    /// <param name="options">The solver options.</param>
    /// <returns>The world.</returns>
    internal static SpikeWorld RotatingBox(SolverOptions options) {
        ArgumentNullException.ThrowIfNull(argument: options);
    ...
    /// <returns>The world.</returns>
    internal static SpikeWorld HighSpeedApproach(SolverOptions options, double height, double downwardSpeed) {
        ArgumentNullException.ThrowIfNull(argument: options);
    ...
    /// <param name="options">The solver options.</param>
    /// <returns>The world.</returns>
    internal static SpikeWorld DeepOverlap(SolverOptions options) {
        ArgumentNullException.ThrowIfNull(argument: options);
    ...
    /// <param name="options">The solver options.</param>
    /// <returns>The world.</returns>
    internal static SpikeWorld BoxInCorner(SolverOptions options) {
        ArgumentNullException.ThrowIfNull(argument: options);
    ...
    /// <returns>The options.</returns>
    internal static SolverOptions BoxInCornerOptions(int rateHz, int substepCount, int solveIterations = 1, bool warmStart = true, bool canonicalOrder = true) =>
        new() {
            RateHz = rateHz,
            SubstepCount = substepCount,
            SolveIterations = solveIterations,
