...
/// <summary>
/// H9 — <see cref="SafeName"/> previously carried no length ceiling at all: three individually-valid names could
...
/// <see cref="SafeName.TryParse"/> itself, then proves the SAME check now gives the resolver's own composed
...
public sealed class WorldSafeNameLawTests {
    ...
    // ALREADY SafeName-typed and SafeName had no length rule to violate. Two long-but-individually-valid
