...
public sealed class StateDynamicsRebaseLawTests {
    ...
    private static readonly DynamicsRow KickNegative = new(
        Damping: 1f,
        Frequency: 1f,
        Name: "kickNeg",
        Response: -1f
    ...
    public void Undo_RestoresTheRebasedTraitBitExactly() {
        ...
        ); // the control: the second write genuinely rebased.
