...
public sealed class BindingBarAuthoringValidationLawTests {
    public static IEnumerable<object[]> Cases() {
        ...
        yield return ["layouts['only'].banks['resting'].anchor.inset", Policy(layout: layout with { Banks = Banks(new WorldBindingBarBankPlacement(Pieces: [], Anchor: new WorldBindingBarAnchor(Edge: BindingBarEdge.Left, Inset: float.NaN))) }), Policy(layout: layout with { Banks = Banks(new WorldBindingBarBankPlacement(Pieces: [], Anchor: new WorldBindingBarAnchor(Edge: BindingBarEdge.Left, Inset: 0f))) })];
