...
public sealed class PresentationReadsStateLawTests {
    ...
    public void BindingOverlay_WhenUndeclaredRow_RefusesByName_ControlDeclaredRowClean() {
        Laws.RefusalWithControl(
            ...
            controlOutcome: static () => WorldDefinitionValidator.TryValidateLocally(
    ...
    public void BindingOverlay_WithWhenOnAStateRow_ActivatesOnTheTickTheRowCrosses() {
        ...
        Assert.False(condition: bindings.TryPageView(
            pageId: RevealedPageId,
            slot: 0,
            view: out _
        ));
        ...
        Assert.True(condition: bindings.TryPageView(
            pageId: RevealedPageId,
            slot: 0,
            view: out _
        ));
    ...
    public void SkyZenith_BoundToStateTextCell_RecolorsOnTheNextEmit_WithNoRebake() {
        ...
        var sky = new WorldRenderSky(Layers: [new WorldRenderSkyLayer.Gradient(Stops: [new WorldRenderSkyStop(
                    ...
                    Elevation: 1f,
                    Color: new BindableColor(Raw: "state.colors.zenith")
                )])]);
        var colorsRow = new WorldStateRow(
