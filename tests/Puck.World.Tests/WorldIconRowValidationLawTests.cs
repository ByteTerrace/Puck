...
public sealed class WorldIconRowValidationLawTests {
    ...
    public void NonMonoGlyphFontRefusesWhileMonoPasses() {
        var denied = WithIconRow(new WorldIconRow(Name: "icon", Glyph: new WorldIconGlyphRef(Font: WorldIconFontCatalog.InterRegular, Glyph: "U+2191")));
        var admitted = WithIconRow(new WorldIconRow(Name: "icon", Glyph: new WorldIconGlyphRef(Font: WorldIconFontCatalog.JetBrainsMonoRegular, Glyph: "U+2191")));
    ...
    public void NonAsciiLabelRefusesWhileAsciiPasses() {
        var denied = WithIconRow(new WorldIconRow(Name: "icon", Label: "©"));
        var admitted = WithIconRow(new WorldIconRow(Name: "icon", Label: "OK"));
