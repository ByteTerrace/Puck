...
public sealed class SteeringIntentLawTests {
    ...
    private static WorldBody JoinAndPoseAwayFromHome(WorldFixture fixture, float distance) {
        ...
        body.Pose(
            x: 0f,
            y: ((float)((double)body.FixedPosition.Y)),
            z: -distance,
            yawRadians: 0f,
            pitchRadians: 0f,
            rollRadians: 0f
    ...
    public void ARestoringGainConvergesTheBodyBackTowardHome_WhileAZeroGainOnlyRecedes() {
        ...
        var restoringBody = JoinAndPoseAwayFromHome(
        ...
        var controlBody = JoinAndPoseAwayFromHome(
            distance: StartDistance,
            fixture: control
        );
    ...
    public void ApproachAltitudeGain_GovernsTheSensedShapeIndependentlyOfTheOmittedRoamGain() {
        static FixedQ4816 ProducedMoveUp(float gain) {
            using var fixture = Fixtures.FreshServer(definition: ApproachOnlyFlyerDocument(
                approachAltitudeGain: gain,
                sensedRange: 100f
            ));
            var follower = JoinSeat(
                fixture: fixture,
                slot: 0,
                x: 0f,
                z: 0f
    ...
    public void ApproachOnlyProducer_HoldsForeverOnAnUnsensedTick_WhereARoamAuthoringProducerHomesToItsSeededAltitude() {
        ...
        var approachOnlyBody = JoinAndPose(
            fixture: approachOnly,
            x: 3f,
            y: 1f,
            z: 0f
        );
    ...
    public void TheAltitudeTermIsMeasuredAlongTheBodysResolvedUp_NotBakedToWorldY() {
        ...
        var tiltedGravity = new DocumentVector3(
            x: (-GravityMagnitude * 0.6f),
            y: (-GravityMagnitude * 0.8f),
            z: 0f
        );
    ...
    public void TheRoamOscillatorAdvancesEveryTickRegardlessOfWhichShapeGoverns() {
        ...
        prey.Pose(
            x: 5000f,
            y: ((float)((double)prey.FixedPosition.Y)),
            z: 5000f,
            yawRadians: 0f,
            pitchRadians: 0f,
            rollRadians: 0f
