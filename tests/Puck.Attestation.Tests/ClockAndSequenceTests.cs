...
public sealed class ClockAndSequenceTests {
    ...
    public void ClockSkew_NotBeforeEqualToNow_IsInsideTheInclusiveWindow() {
        ...
        var result = VerifyAt(codec: codec, chain: chain, trust: trust, attestation: claim, now: Now, store: null);
    ...
    public void DirectedClaimWithoutSequence_ReplaysFreelyAtItsOwnAudience() {
        ...
        var first = VerifyAt(codec: codec, chain: chain, trust: trust, attestation: claim, now: Now, store: store);
        var second = VerifyAt(codec: codec, chain: chain, trust: trust, attestation: claim, now: Now, store: store);
    ...
    public void FiniteReplayHorizon_SequencedWindowLongerThanHorizon_IsRefused() {
        ...
        var result = VerifyAt(codec: codec, chain: chain, trust: trust, attestation: tooLongSequenced, now: Now, store: null);
    ...
    public void ExtremeNotBefore_RefusesWithoutInt64SubtractionOrTimeSpanOverflow() {
        ...
        var result = VerifyAt(codec: codec, chain: chain, trust: trust, attestation: extremeNotBefore, now: Now, store: null);
