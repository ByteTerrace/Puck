...
public sealed class CartridgeDirectSoundTests {
    ...
    public void APlayedSampleIsMixedIntoTheBufferAndTheTransferRuns() {
        ...
        var document = CartridgeDocuments.Create(target: "agb", title: "PCM") with {
            ...
            Rules = [
                new CartridgeRule(Name: "fire", When: CartridgeExpressions.Gate(left: CartridgeExpressions.Of(state: "phase"), comparison: ActionStateComparison.Equal, right: CartridgeExpressions.Of(constant: 3)),
