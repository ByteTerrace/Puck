...
public sealed partial class ShaderRegisterBindingLawTests {
    ...
    private static readonly string[] KnownViolations = [
        ...
        "src/Puck.SdfVm/Assets/Shaders/Sdf/sdf-sky.comp.hlsl output register(u0) binding(4, 0)",
        "src/Puck.SdfVm/Assets/Shaders/Sdf/sdf-visibility.hlsli sdfVisibilityRecords register(t45) binding(50, 0)",
        "src/Puck.SdfVm/Assets/Shaders/Sdf/sdf-visibility.hlsli sdfVisibilityRecords register(u1) binding(49, 0)",
        ...
        "src/Puck.SdfVm/Assets/Shaders/Sdf/sdf-world-views.comp.hlsl output register(u0) binding(4, 0)",
