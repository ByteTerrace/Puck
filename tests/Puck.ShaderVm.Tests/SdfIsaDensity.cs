...
public sealed class SdfIsaDensity {
    ...
    private static IReadOnlyList<AuthoredShape> Shapes() {
        var mirrorX = new ShapeDomainOp.Symmetry(Normal: new DocumentVector3(
            x: 1f,
            y: 0f,
            z: 0f
        ));
        var mirrorZ = new ShapeDomainOp.Symmetry(Normal: new DocumentVector3(
            x: 0f,
            y: 0f,
            z: 1f
        ));
        ...
        void Ground(float cell, int material, bool wallpaper, bool cuts) {
            shapes.Add(item: new AuthoredShape(
                ...
                Domain: (wallpaper
                ? [new ShapeDomainOp.Wallpaper(
                            Cell: new DocumentVector2(value: new Vector2(
                                x: cell,
                                y: cell
                            )),
        ...
        Ground(
            cell: 1f,
            cuts: true,
            material: NullWorldScene.Paper,
            wallpaper: true
        );
        Ground(
            cell: 1f,
            cuts: true,
            material: NullWorldScene.Sage,
            wallpaper: false
        );
        Ground(
            cell: 2f,
            cuts: true,
            material: NullWorldScene.BlueDeep,
            wallpaper: true
        );
        Ground(
            cell: 1f,
            cuts: false,
            material: NullWorldScene.Stone,
            wallpaper: false
        );
        ...
        foreach (var (type, position, scale, material, smooth) in (((SdfSolidPrimitive, Vector3, Vector3, int, float)[])[
            ...
            (SdfSolidPrimitive.Cylinder, new Vector3(
                ...
                y: 2.9f,
                z: 0.45f
            ), NullWorldScene.PillarStone, 0.25f),
            (SdfSolidPrimitive.Cylinder, new Vector3(
                x: 6f,
                y: 6.35f,
                z: 6f
                ...
                y: 0.3f,
                z: 0.8f
            ), NullWorldScene.PillarTrim, 0.25f),
            (SdfSolidPrimitive.Sphere, new Vector3(
                x: 6f,
                y: 7f,
                z: 6f
            ), new Vector3(value: 0.45f), NullWorldScene.PillarLamp, 0.1f),
        ])) {
            shapes.Add(item: new AuthoredShape(
                Blend: SdfBlendOp.Union,
