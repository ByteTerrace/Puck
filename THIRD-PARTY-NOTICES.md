...
| **Inter** — The Inter Project Authors, <https://github.com/rsms/inter> (`v4.1`) | SIL Open Font License 1.1 | UI text (Regular/Medium/SemiBold), baked into the committed MTSDF font atlas at [`src/Puck.Text/Assets/Fonts/`](src/Puck.Text/Assets/Fonts/). Source TTFs + license text are vendored at [`src/Puck.Text/Assets/Fonts/source/`](src/Puck.Text/Assets/Fonts/source/). OFL-1.1 requires the copyright + license notice to travel with the font data and reserves the original font name for unmodified versions. |
| **JetBrains Mono** — The JetBrains Mono Project Authors, <https://github.com/JetBrains/JetBrainsMono> | SIL Open Font License 1.1 | Console / diegetic terminal text (Regular), baked into the same committed MTSDF font atlas. Source TTF + license text are vendored alongside Inter under [`src/Puck.Text/Assets/Fonts/source/`](src/Puck.Text/Assets/Fonts/source/). Same OFL-1.1 obligations as above. |
